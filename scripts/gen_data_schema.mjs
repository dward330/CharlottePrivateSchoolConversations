...
for (const s of STRUCTURED) {
  ...
  if (s.topic === 'college-support') {
    ...
    w('- **Anchor both labels on the POOLED five-year rate**, which is the figure the')
    w('  subhead and third stat tile quote beside them. A latest-term rate can disagree')
    w('  because single-year cells are small. Ties break on the larger denominator --')
    w('  28 of 28 outranks 10 of 10.')
