...
/**
 * TEMPORARY — translation print-out aid. Restored for the Telugu print-out
 * (PR #63); remove again once that print-out is signed off.
 *
 * This is its second life: added in #60 for the Kreyòl print-outs, removed in
 * #62, restored here. It keeps coming back because expanding the panels is a
 * required print-out step, not a convenience — the financial-aid sections
 * holding the 7-digit figures are collapsed on load, so an unexpanded page
 * renders ~17k characters against ~152k expanded, and a print-out that skips
 * this reports clean without having shown the part that breaks.
 *
