...
import { hickoryGroveChristian } from './clubsPrograms/hickory-grove-christian.ts'
import { gastonDay } from './clubsPrograms/gaston-day.ts'
import { trinityEpiscopal } from './clubsPrograms/trinity-episcopal.ts'
