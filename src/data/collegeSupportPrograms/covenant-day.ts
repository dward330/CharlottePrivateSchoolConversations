...
export const covenantDay: CollegeSupportProgram = {
  ...
  outcomes: {
    ...
    colleges: [
      ...
      { name: 'Penn State University', rankLabel: 'National Rank #63', cats: ['nu75', 'p4'] },
      ...
      { name: 'Sewanee: University of the South', rankLabel: 'Liberal Rank #46', cats: ['lac75'] },
      ...
      { name: 'University of Illinois', rankLabel: 'National Rank #69', cats: ['nu75', 'p4'] },
      ...
      { name: 'University of Massachusetts', rankLabel: 'National Rank #69', cats: ['nu75'] },
      ...
      { name: 'University of NC at Chapel Hill', rankLabel: 'National Rank #22', cats: ['nu75', 'p4'], enrolling: true },
