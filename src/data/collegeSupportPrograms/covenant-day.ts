...
export const covenantDay: CollegeSupportProgram = {
  ...
  outcomes: {
    ...
    colleges: [
      ...
      { name: 'Augustana College', rankLabel: 'Liberal Rank #96', cats: [] },
      ...
      { name: 'Bowling Green State University', rankLabel: 'National Rank #293', cats: [] },
      ...
      { name: 'College of William & Mary', rankLabel: 'National Rank #51', cats: ['nu75'], enrolling: true },
      ...
      { name: 'Covenant College', rankLabel: 'Liberal Rank #126', cats: [], enrolling: true },
      ...
      { name: 'East Tennessee State Univ.', rankLabel: 'National Rank #301', cats: [], enrolling: true },
      ...
      { name: 'Gardner-Webb University', rankLabel: 'National Rank #384', cats: [], enrolling: true },
      { name: 'George Washington University', rankLabel: 'National Rank #59', cats: ['nu75'], enrolling: true },
      ...
      { name: 'Gordon College', rankLabel: 'Liberal Rank #156', cats: [], enrolling: true },
      ...
      { name: 'Houghton University', rankLabel: 'Liberal Rank #146', cats: [] },
      { name: 'Indiana University', rankLabel: 'National Rank #73', cats: ['nu75', 'p4'] },
      ...
      { name: 'Johnson C. Smith University', rankLabel: 'Liberal Rank #173', cats: ['hbcu'] },
      { name: 'Kennesaw State University', rankLabel: 'National Rank #373', cats: [] },
      ...
      { name: 'Louisiana Tech University', rankLabel: 'National Rank #318', cats: [], enrolling: true },
      { name: 'Loyola University Chicago', rankLabel: 'National Rank #132', cats: [], enrolling: true },
      ...
      { name: 'Maryville College', rankLabel: 'Liberal Rank #170', cats: [] },
      ...
      { name: 'Mississippi State University', rankLabel: 'National Rank #208', cats: ['p4'], enrolling: true },
      ...
      { name: 'NC A&T State University', rankLabel: 'National Rank #232', cats: ['hbcu'], enrolling: true },
      ...
      { name: 'Nova Southeastern University', rankLabel: 'National Rank #257', cats: [], enrolling: true },
      ...
      { name: 'Palm Beach Atlantic University', rankLabel: 'National Rank #384', cats: [], enrolling: true },
      { name: 'Paul D. Camp CC', cats: [], enrolling: true },
      { name: 'Penn State University', rankLabel: 'National Rank #59', cats: ['nu75', 'p4'] },
      ...
      { name: 'Rensselaer Polytechnic Inst.', rankLabel: 'National Rank #64', cats: ['nu75'] },
      ...
      { name: 'Sewanee: University of the South', rankLabel: 'Liberal Rank #45', cats: ['lac75'] },
      { name: 'South Piedmont CC', cats: [] },
      { name: 'Southeastern CC', cats: [] },
      { name: 'Southeastern University', rankLabel: 'National Rank #395-434', cats: [], enrolling: true },
      ...
      { name: 'University of Akron', rankLabel: 'National Rank #373', cats: [] },
      ...
      { name: 'University of California (SB)', rankLabel: 'National Rank #40', cats: ['nu75'] },
      { name: 'University of Central Florida', rankLabel: 'National Rank #117', cats: ['p4'] },
      { name: 'University of Cincinnati', rankLabel: 'National Rank #158', cats: ['p4'], enrolling: true },
      { name: 'University of Colorado', rankLabel: 'National Rank #75', cats: ['nu75', 'p4'] },
      { name: 'University of Connecticut', rankLabel: 'National Rank #75', cats: ['nu75'], enrolling: true },
      ...
      { name: 'University of Illinois', rankLabel: 'National Rank #36', cats: ['nu75', 'p4'] },
      ...
      { name: 'University of Louisville', rankLabel: 'National Rank #147', cats: ['p4'], enrolling: true },
      ...
      { name: 'University of Massachusetts', rankLabel: 'National Rank #64', cats: ['nu75'] },
      ...
      { name: 'University of Minnesota', rankLabel: 'National Rank #69', cats: ['nu75', 'p4'], enrolling: true },
      ...
      { name: 'University of NC at Asheville', rankLabel: 'Liberal Rank #135', cats: [] },
      { name: 'University of NC at Chapel Hill', rankLabel: 'National Rank #26', cats: ['nu75', 'p4'], enrolling: true },
      { name: 'University of NC at Charlotte', rankLabel: 'National Rank #143', cats: [], enrolling: true },
      { name: 'University of NC at Greensboro', rankLabel: 'National Rank #198', cats: [], enrolling: true },
      { name: 'University of NC at Pembroke', cats: [] },
      { name: 'University of NC at Wilmington', rankLabel: 'National Rank #198', cats: [], enrolling: true },
      ...
      { name: 'University of South Florida', rankLabel: 'National Rank #88', cats: [], enrolling: true },
      ...
      { name: 'Utah State University', rankLabel: 'National Rank #242', cats: [] },
      { name: 'Villanova University', rankLabel: 'National Rank #57', cats: ['nu75'] },
      { name: 'Virginia Commonwealth Univ.', rankLabel: 'National Rank #139', cats: [] },
      ...
      { name: 'Western Kentucky University', rankLabel: 'National Rank #363', cats: [] },
      ...
      { name: 'Xavier University', rankLabel: 'National Rank #208', cats: [], enrolling: true },
    ],
