...
export const covenantDay: CollegeSupportProgram = {
  ...
  outcomes: {
    headline:
      'About 350 institutions on the published 2023–2026 acceptance list — with matriculations bolded, so you can see where students actually went.',
    subhead:
    ...
    stats: [
      { value: '~350', label: 'institutions on the 2023–2026 acceptance list' },
    ...
    collegesTitle: 'Notable names, with matriculation recovered from the bold type',
    colleges: [
      { name: 'Dartmouth College', rankLabel: 'Ivy', cats: ['ivy', 'ivyplus', 'nu75'], enrolling: true },
      { name: 'University of Pennsylvania', rankLabel: 'Ivy', cats: ['ivy', 'ivyplus', 'nu75'], enrolling: true },
      { name: 'Duke University', rankLabel: '“Ivy Plus”', cats: ['ivyplus', 'nu75', 'p4'], enrolling: true },
      ...
      { name: 'UNC-Chapel Hill', cats: ['nu75', 'p4'], enrolling: true },
      ...
      { name: 'U.S. Air Force Academy', cats: ['lac75'] },
      { name: 'NC A&T State University', cats: ['hbcu'], enrolling: true },
      { name: 'Clemson University', cats: ['p4'], enrolling: true },
      { name: 'NC State University', cats: ['nu75', 'p4'], enrolling: true },
      { name: 'Covenant College', cats: [], enrolling: true },
      { name: 'Wheaton College (IL)', cats: [], enrolling: true },
    ],
    collegesTotal: '~350 institutions on the current list',
