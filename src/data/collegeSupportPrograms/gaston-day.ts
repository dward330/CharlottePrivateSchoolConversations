...
const colleges = [
  ...
  { name: 'Indiana University (Bloomington)', cats: ['nu75'] },
  ...
  { name: 'Penn State University (University Park)', cats: ['nu75'] },
  ...
  { name: 'Soka University of America', cats: ['lac75'] },
  ...
  { name: 'The College of William and Mary', cats: ['nu75'] },
  ...
  { name: 'Tougaloo College', cats: ['hbcu'] },
  ...
  { name: 'University of California (Los Angeles)', cats: ['nu75'] },
  { name: 'University of California (Merced)', cats: ['nu75'] },
  ...
  { name: 'University of Virginia (Main Campus)', cats: ['nu75'] },
  { name: 'University of Washington (Seattle Campus)', cats: ['nu75'] },
  { name: 'University of Wisconsin (Madison)', cats: ['nu75'] },
  ...
  { name: 'Whitman College', cats: ['lac75'] },
...
export const gastonDay: CollegeSupportProgram = {
  ...
  ncAdmissions: {
    ...
    subhead:
      'UNC-Chapel Hill is the hard one: 27.3% in Fall 2025 — 3 of 11 — against far higher rates at the less-selective universities. These are UNC-system figures published by the state, not the school’s own.',
    stats: [
      { value: '242', label: 'applications to the six universities, Fall 2021–2025' },
