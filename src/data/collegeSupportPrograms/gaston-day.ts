...
export const gastonDay: CollegeSupportProgram = {
  ...
  outcomes: {
    ...
    buckets: [
      ...
      { tier: 'Ivy Plus', count: '6', note: 'adds Stanford, Duke, Johns Hopkins, Georgetown' },
      { tier: 'Top-75 National Universities', count: '40' },
      { tier: 'Top-75 Liberal Arts Colleges', count: '21', note: 'incl. Swarthmore, Middlebury, Davidson, Colby, Bryn Mawr' },
      { tier: 'Power Four athletics', count: '36 / 68' },
      { tier: 'HBCUs', count: '4', note: 'Hampton, NC A&T, NC Central, Winston-Salem State' },
    ],
    bucketsNote:
  ...
  verdict: {
    ...
    points: [
      ...
      { label: 'The acceptance breadth is genuine', text: '**231 institutions** including Yale, Stanford, Dartmouth, Duke, Johns Hopkins and Georgetown, plus 21 top-75 liberal arts colleges — wide range for classes of ~35.' },
