...
const colleges = [
  ...
  { name: 'American University', rankLabel: 'National Rank #88', cats: [] },
  { name: 'Appalachian State University', cats: [] },
  { name: 'Auburn University', rankLabel: 'National Rank #105', cats: ['p4'] },
  { name: 'Bard College', rankLabel: 'Liberal Rank #70', cats: [] },
  { name: 'Barry University', rankLabel: 'National Rank #395-434', cats: [] },
  ...
  { name: 'Brandeis University', rankLabel: 'National Rank #69', cats: [] },
  { name: 'Brevard College', cats: [] },
  { name: 'Bridgewater College', rankLabel: 'Liberal Rank #167', cats: [] },
  { name: 'Brown University', rankLabel: 'National Rank #13', cats: ['ivy', 'ivyplus', 'nu75'] },
  { name: 'Butler University', cats: [] },
  { name: 'California State University Long Beach', rankLabel: 'National Rank #127', cats: [] },
  ...
  { name: 'Clark University', rankLabel: 'National Rank #132', cats: [] },
  { name: 'Clemson University', rankLabel: 'National Rank #57', cats: ['nu75', 'p4'] },
  ...
  { name: 'Colorado School of Mines', rankLabel: 'National Rank #80', cats: [] },
  { name: 'Colorado State University', rankLabel: 'National Rank #151', cats: [] },
  ...
  { name: 'Georgia Institute of Technology', rankLabel: 'National Rank #33', cats: ['nu75', 'p4'] },
  ...
  { name: 'Indiana University Bloomington', rankLabel: 'National Rank #73', cats: ['nu75', 'p4'] },
  { name: 'Iowa State University', rankLabel: 'National Rank #117', cats: ['p4'] },
  ...
  { name: 'Lincoln Memorial University', rankLabel: 'National Rank #343', cats: [] },
  { name: 'Louisiana State University', rankLabel: 'National Rank #169', cats: ['p4'] },
  { name: 'Loyola Marymount University', rankLabel: 'National Rank #102', cats: [] },
  { name: 'Loyola University Chicago', rankLabel: 'National Rank #132', cats: [] },
  { name: 'Lynn University', cats: [] },
  { name: 'Manhattan School of Music', cats: [] },
  { name: 'Marist University', cats: [] },
  { name: 'Marquette University', rankLabel: 'National Rank #88', cats: [] },
  { name: 'Mars Hill University', cats: [] },
  { name: 'Marymount Manhattan College', cats: [] },
  { name: 'Mercer University', rankLabel: 'National Rank #169', cats: [] },
  { name: 'Merrimack College', cats: [] },
  { name: 'Methodist University', cats: [] },
  { name: 'Miami University (Ohio)', rankLabel: 'National Rank #143', cats: [] },
  ...
  { name: 'North Carolina State University', rankLabel: 'National Rank #59', cats: ['nu75', 'p4'] },
  { name: 'Northeastern University', rankLabel: 'National Rank #47', cats: ['nu75'] },
  { name: 'Northwestern University', rankLabel: 'National Rank #6', cats: ['ivyplus', 'nu75', 'p4'] },
  ...
  { name: 'Ohio University', rankLabel: 'National Rank #198', cats: [] },
  ...
  { name: 'Pace University', rankLabel: 'National Rank #273', cats: [] },
  { name: 'Penn State Berks', cats: [] },
  { name: 'Penn State University', rankLabel: 'National Rank #59', cats: [] },
  ...
  { name: 'Randolph College', rankLabel: 'Liberal Rank #156', cats: [] },
  { name: 'Randolph-Macon College', rankLabel: 'Liberal Rank #96', cats: [] },
  { name: 'Rensselaer Polytechnic Institute', cats: [] },
  { name: 'Rhodes College', rankLabel: 'Liberal Rank #51', cats: ['lac75'] },
  ...
  { name: 'Sewanee: The University of the South', rankLabel: 'Liberal Rank #46', cats: ['lac75'] },
  { name: 'Siena University', cats: [] },
  { name: 'Smith College', rankLabel: 'Liberal Rank #13', cats: ['lac75'] },
  { name: 'Southern Methodist University', rankLabel: 'National Rank #88', cats: ['p4'] },
  { name: 'Southwest Minnesota State University', cats: [] },
  { name: 'Spalding University', cats: [] },
  { name: 'St. Lawrence University', rankLabel: 'Liberal Rank #58', cats: [] },
  { name: 'Stetson University', cats: [] },
  { name: 'Stevenson University', cats: [] },
  { name: 'Suffolk University', rankLabel: 'National Rank #257', cats: [] },
  { name: 'Susquehanna University', rankLabel: 'Liberal Rank #96', cats: [] },
  { name: 'Swarthmore College', rankLabel: 'Liberal Rank #4', cats: ['lac75'] },
  { name: 'Sweet Briar College', rankLabel: 'Liberal Rank #164', cats: [] },
  ...
  { name: 'The College of Wooster', rankLabel: 'Liberal Rank #76', cats: [] },
  ...
  { name: 'Tulane University of Louisiana', rankLabel: 'National Rank #69', cats: [] },
  { name: 'Tusculum University', cats: [] },
  { name: 'United States Air Force Academy', rankLabel: 'Liberal Rank #5', cats: ['lac75'] },
  { name: 'United States Military Academy at West Point', rankLabel: 'Liberal Rank #13', cats: ['lac75'] },
  ...
  { name: 'University of California, Merced', rankLabel: 'National Rank #57', cats: [] },
  { name: 'University of California, Santa Cruz', rankLabel: 'National Rank #88', cats: [] },
  ...
  { name: 'University of Colorado Denver', rankLabel: 'National Rank #232', cats: [] },
  ...
  { name: 'University of Florida', rankLabel: 'National Rank #28', cats: ['nu75', 'p4'] },
  { name: 'University of Georgia', rankLabel: 'National Rank #46', cats: ['nu75', 'p4'] },
  ...
  { name: 'University of Maryland', rankLabel: 'National Rank #46', cats: ['nu75', 'p4'] },
  { name: 'University of Massachusetts Amherst', rankLabel: 'National Rank #64', cats: ['nu75'] },
  { name: 'University of Miami', rankLabel: 'National Rank #59', cats: ['nu75', 'p4'] },
  ...
  { name: 'University of Missouri', rankLabel: 'National Rank #102', cats: ['p4'] },
  { name: 'University of Nevada, Las Vegas', rankLabel: 'National Rank #232', cats: [] },
  { name: 'University of North Carolina School of the Arts', cats: [] },
  { name: 'University of North Carolina Wilmington', rankLabel: 'National Rank #198', cats: [] },
  { name: 'University of North Carolina at Asheville', rankLabel: 'Liberal Rank #135', cats: [] },
  { name: 'University of North Carolina at Chapel Hill', rankLabel: 'National Rank #26', cats: ['nu75', 'p4'] },
  { name: 'University of North Carolina at Charlotte', rankLabel: 'National Rank #143', cats: [] },
  { name: 'University of North Carolina at Greensboro', rankLabel: 'National Rank #198', cats: [] },
  { name: 'University of North Carolina at Pembroke', cats: [] },
  { name: 'University of North Dakota', rankLabel: 'National Rank #242', cats: [] },
  { name: 'University of North Florida', rankLabel: 'National Rank #222', cats: [] },
  { name: 'University of Pittsburgh', rankLabel: 'National Rank #69', cats: ['nu75', 'p4'] },
  ...
  { name: 'University of South Carolina', rankLabel: 'National Rank #121', cats: ['p4'] },
  { name: 'University of South Florida', rankLabel: 'National Rank #88', cats: [] },
  { name: 'University of Toronto (Canada)', cats: [] },
  { name: 'University of Utah', rankLabel: 'National Rank #151', cats: ['p4'] },
  { name: 'University of Vermont', rankLabel: 'National Rank #132', cats: [] },
  { name: 'University of Virginia', rankLabel: 'National Rank #26', cats: ['nu75', 'p4'] },
  { name: 'University of Washington', rankLabel: 'National Rank #42', cats: ['nu75', 'p4'] },
  { name: 'University of Wisconsin-Madison', rankLabel: 'National Rank #36', cats: ['nu75', 'p4'] },
  { name: 'University of Wyoming', rankLabel: 'National Rank #220', cats: [] },
  { name: 'Vanderbilt University', rankLabel: 'National Rank #15', cats: ['nu75', 'p4'] },
  { name: 'Vassar College', rankLabel: 'Liberal Rank #12', cats: ['lac75'] },
  { name: 'Villanova University', rankLabel: 'National Rank #57', cats: ['nu75'] },
  { name: 'Virginia Commonwealth University', rankLabel: 'National Rank #139', cats: [] },
  { name: 'Virginia Polytechnic Institute and State University', rankLabel: 'National Rank #47', cats: ['nu75', 'p4'] },
  { name: 'Virginia Wesleyan University', rankLabel: 'Liberal Rank #178', cats: [] },
  { name: 'Wake Forest University', rankLabel: 'National Rank #47', cats: ['nu75', 'p4'] },
  { name: 'Warren Wilson College', rankLabel: 'Liberal Rank #183-201', cats: [] },
  { name: 'Wartburg College', rankLabel: 'Liberal Rank #156', cats: [] },
  { name: 'Washington State University', rankLabel: 'National Rank #192', cats: [] },
  ...
  { name: 'Western New England University', rankLabel: 'National Rank #283', cats: [] },
  { name: 'Westmont College', rankLabel: 'Liberal Rank #115', cats: [] },
  { name: 'Wheaton College (MA)', rankLabel: 'Liberal Rank #76', cats: [] },
  { name: 'Widener University', rankLabel: 'National Rank #301', cats: [] },
  ...
  { name: 'Wofford College', rankLabel: 'Liberal Rank #57', cats: ['lac75'] },
