...
const colleges = [
  ...
  { name: 'Arizona State University', rankLabel: 'National Rank #117', cats: ['p4'] },
  { name: 'Art Center College of Design', cats: [] },
  { name: 'Auburn University', rankLabel: 'National Rank #105', cats: ['p4'], enrolling: true },
  { name: 'Ball State University', rankLabel: 'National Rank #213', cats: [] },
  ...
  { name: 'Brenau University', rankLabel: 'National Rank #395-434', cats: [] },
  { name: 'Bridgewater College', rankLabel: 'Liberal Rank #167', cats: [] },
  { name: 'Brigham Young University', rankLabel: 'National Rank #110', cats: ['p4'] },
  ...
  { name: 'Central Michigan University', rankLabel: 'National Rank #283', cats: [] },
  { name: 'Central Piedmont Community College', cats: [] },
  { name: 'Christopher Newport University', cats: [] },
  { name: 'Clark Atlanta University', rankLabel: 'National Rank #329', cats: ['hbcu'], enrolling: true },
  { name: 'Clarkson University', rankLabel: 'National Rank #143', cats: [] },
  ...
  { name: 'Delaware State University', cats: ['hbcu'] },
  ...
  { name: 'Duquesne University', rankLabel: 'National Rank #169', cats: [] },
  { name: 'Durham University', cats: [] },
  { name: 'Earlham College', rankLabel: 'Liberal Rank #76', cats: [] },
  ...
  { name: 'Florida A&M University', rankLabel: 'National Rank #169', cats: ['hbcu'] },
  { name: 'Florida Atlantic University', cats: [] },
  { name: 'Florida Gulf Coast University', rankLabel: 'National Rank #318', cats: [] },
  { name: 'Florida Institute of Technology', rankLabel: 'National Rank #232', cats: [], enrolling: true },
  ...
  { name: 'Hampton University', rankLabel: 'National Rank #273', cats: ['hbcu'], enrolling: true },
  ...
  { name: 'Hobart and William Smith Colleges', rankLabel: 'Liberal Rank #73', cats: [] },
  { name: 'Howard University', rankLabel: 'National Rank #88', cats: ['hbcu'], enrolling: true },
  { name: 'Indiana University', rankLabel: 'National Rank #73', cats: [], enrolling: true },
  ...
  { name: 'Liberty University', rankLabel: 'National Rank #395-434', cats: [], enrolling: true },
  { name: 'Long Island University', rankLabel: 'National Rank #373', cats: [] },
  ...
  { name: 'Meredith College', rankLabel: 'Liberal Rank #115', cats: [] },
  { name: 'Metropolitan State University of Denver', cats: [] },
  { name: 'Miami University', rankLabel: 'National Rank #143', cats: [] },
  { name: 'Michigan State University', rankLabel: 'National Rank #63', cats: ['nu75', 'p4'] },
  { name: 'Middle Tennessee State University', rankLabel: 'National Rank #257', cats: [] },
  ...
  { name: 'Montclair State University', rankLabel: 'National Rank #158', cats: [] },
  { name: 'Morehouse College', rankLabel: 'Liberal Rank #96', cats: ['hbcu'] },
  { name: 'Morgan State University', rankLabel: 'National Rank #329', cats: ['hbcu'] },
  ...
  { name: 'North Carolina A&T State University', rankLabel: 'National Rank #232', cats: ['hbcu'], enrolling: true },
  ...
  { name: 'Oglethorpe University', rankLabel: 'Liberal Rank #156', cats: [] },
  { name: 'Ohio University', rankLabel: 'National Rank #198', cats: [] },
  { name: 'Oklahoma City University', cats: [] },
  { name: 'Oklahoma State University', rankLabel: 'National Rank #198', cats: ['p4'] },
  ...
  { name: 'Purdue University', rankLabel: 'National Rank #46', cats: ['nu75', 'p4'], enrolling: true },
  { name: 'Queens University of Charlotte', cats: [], enrolling: true },
  { name: 'Radford University', cats: [] },
  { name: 'Randolph-Macon College', rankLabel: 'Liberal Rank #96', cats: [], enrolling: true },
  ...
  { name: 'Rochester Institute of Technology', rankLabel: 'National Rank #88', cats: [], enrolling: true },
  { name: 'Rollins College', cats: [] },
  { name: 'Roosevelt University', rankLabel: 'National Rank #395-434', cats: [] },
  ...
  { name: 'Sarah Lawrence College', rankLabel: 'Liberal Rank #108', cats: [] },
  ...
  { name: 'Tennessee State University', rankLabel: 'National Rank #395-434', cats: ['hbcu'] },
  ...
  { name: 'Texas State University', rankLabel: 'National Rank #257', cats: [] },
  ...
  { name: 'University of Colorado (Boulder)', rankLabel: 'National Rank #97', cats: [], enrolling: true },
  ...
  { name: 'University of Hartford', rankLabel: 'National Rank #301', cats: [] },
  { name: 'University of Illinois (Urbana-Champaign)', rankLabel: 'National Rank #36', cats: [] },
  ...
  { name: 'University of Maryland Eastern Shore', rankLabel: 'National Rank #395-434', cats: [] },
  { name: 'University of Massachusetts (Amherst)', rankLabel: 'National Rank #64', cats: [] },
  { name: 'University of Massachusetts (Boston)', rankLabel: 'National Rank #213', cats: [] },
  { name: 'University of Memphis', rankLabel: 'National Rank #273', cats: [] },
  ...
  { name: 'University of North Carolina (Asheville)', rankLabel: 'Liberal Rank #135', cats: [] },
  { name: 'University of North Carolina (Chapel Hill)', rankLabel: 'National Rank #26', cats: [], enrolling: true },
  { name: 'University of North Carolina (Charlotte)', rankLabel: 'National Rank #143', cats: [], enrolling: true },
  { name: 'University of North Carolina (Greensboro)', rankLabel: 'National Rank #198', cats: [] },
  ...
  { name: 'University of San Diego', rankLabel: 'National Rank #110', cats: [] },
  ...
  { name: 'University of Tennessee', rankLabel: 'National Rank #102', cats: ['nu75', 'p4'], enrolling: true },
  { name: 'University of Texas', rankLabel: 'National Rank #30', cats: [] },
  { name: 'University of the South (Sewanee)', rankLabel: 'Liberal Rank #45', cats: [], enrolling: true },
  ...
  { name: 'University of Virginia', rankLabel: 'National Rank #26', cats: ['nu75', 'p4'], enrolling: true },
  { name: 'University of Washington', rankLabel: 'National Rank #42', cats: ['nu75', 'p4'] },
  { name: 'University of Wisconsin', rankLabel: 'National Rank #36', cats: [] },
  ...
  { name: 'Washington and Lee University', rankLabel: 'Liberal Rank #21', cats: ['lac75'], enrolling: true },
