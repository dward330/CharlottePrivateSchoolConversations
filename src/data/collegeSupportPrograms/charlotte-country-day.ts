...
const colleges = [
  ...
  { name: 'Howard University', cats: ['hbcu'], enrolling: true },
  { name: 'Indiana University', cats: ['nu75'], enrolling: true },
  ...
  { name: 'Penn State University', cats: ['nu75'] },
  ...
  { name: 'University of California (Berkeley)', cats: ['nu75'] },
  { name: 'University of California (Davis)', cats: ['nu75'] },
  { name: 'University of California (Irvine)', cats: ['nu75'] },
  { name: 'University of California (Los Angeles)', cats: ['nu75'], enrolling: true },
  ...
  { name: 'University of Illinois (Urbana-Champaign)', cats: ['nu75'] },
  ...
  { name: 'University of North Carolina (Chapel Hill)', cats: ['nu75'], enrolling: true },
  ...
  { name: 'University of Wisconsin', cats: ['nu75'] },
