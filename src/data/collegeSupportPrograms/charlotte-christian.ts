...
const colleges = [
  { name: 'Abilene Christian University', rankLabel: 'National Rank #329', cats: [], enrolling: true },
  ...
  { name: 'Biola University', rankLabel: 'National Rank #242', cats: [] },
  ...
  { name: 'College of William and Mary', rankLabel: 'National Rank #51', cats: [] },
  { name: 'University of Colorado-Boulder', rankLabel: 'National Rank #97', cats: [] },
  ...
  { name: 'Florida Agricultural & Mechanical University', rankLabel: 'National Rank #169', cats: [] },
  ...
  { name: 'Georgia Southern University', rankLabel: 'National Rank #343', cats: [], enrolling: true },
  ...
  { name: 'Hillsdale College', rankLabel: 'Liberal Rank #50', cats: [] },
  ...
  { name: 'Johnson C. Smith University', rankLabel: 'Liberal Rank #173', cats: ['hbcu'], enrolling: true },
  ...
  { name: 'Marshall University', rankLabel: 'National Rank #318', cats: [], enrolling: true },
  ...
  { name: 'Michigan State University', rankLabel: 'National Rank #63', cats: ['nu75', 'p4'], enrolling: true },
  { name: 'University of Michigan-Ann Arbor', rankLabel: 'National Rank #21', cats: ['nu75', 'p4'] },
  { name: 'University of Mississippi', rankLabel: 'National Rank #147', cats: ['p4'], enrolling: true },
  { name: 'University of Montana', rankLabel: 'National Rank #363', cats: [] },
  { name: 'Montreat College', cats: [] },
  { name: 'Morehouse College', rankLabel: 'Liberal Rank #96', cats: ['hbcu'] },
  { name: 'New College of Florida', rankLabel: 'Liberal Rank #135', cats: [] },
  ...
  { name: 'University of Northern Colorado', rankLabel: 'National Rank #343', cats: [] },
  { name: 'University of Notre Dame', rankLabel: 'National Rank #18', cats: ['nu75', 'p4'] },
  ...
  { name: 'Pennsylvania State University', rankLabel: 'National Rank #63', cats: ['nu75', 'p4'] },
  { name: 'Penn State University', rankLabel: 'National Rank #59', cats: [], enrolling: true },
  ...
  { name: 'Purdue University-Main Campus', rankLabel: 'National Rank #46', cats: [] },
  ...
  { name: 'The University of the South', cats: [] },
  { name: 'University of South Carolina-Columbia', rankLabel: 'National Rank #121', cats: [] },
  ...
  { name: 'St. John\'s University-New York', rankLabel: 'National Rank #151', cats: [] },
  ...
  { name: 'Trinity University', rankLabel: 'Liberal Rank #37', cats: [] },
  ...
  { name: 'Wheaton College', rankLabel: 'Liberal Rank #50', cats: [], enrolling: true },
