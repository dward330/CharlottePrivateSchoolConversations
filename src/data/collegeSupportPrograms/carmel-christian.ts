...
const colleges = [
  ...
  { name: 'University of Colorado', cats: ['p4'] },
  ...
  { name: 'University of Tennessee', cats: ['p4'] },
  ...
  { name: 'Wheaton College', cats: ['lac75'] },
...
export const carmelChristian: CollegeSupportProgram = {
  /* The area's FIRST card. Unlike every other card here, these figures are
     ...
     source-material/college-support/carmel-christian/
     Carmel Christian School - College Support - UNC System Admissions.md.
  ...
  ncAdmissions: {
    ...
    subhead:
      'UNC-Chapel Hill is the hard one: 25.0% in Fall 2025 — 4 of 16 — against far higher rates at the less-selective universities. These are UNC-system figures published by the state, not the school’s own.',
    stats: [
      { value: '584', label: 'applications to the six universities, Fall 2021–2025' },
