...
const colleges = [
  ...
  { name: 'Rutgers University (New Brunswick)', cats: ['nu75'], enrolling: true },
  ...
  { name: 'University of California (Berkeley)', cats: ['nu75'], enrolling: true },
  ...
  { name: 'University of Wisconsin', cats: ['nu75'], enrolling: true },
