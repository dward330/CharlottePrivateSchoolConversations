...
const colleges = [
  ...
  { name: 'Belhaven University', rankLabel: 'National Rank #395-434', cats: [] },
  { name: 'Belmont Abbey College', cats: [] },
  { name: 'Belmont University', rankLabel: 'National Rank #213', cats: [], enrolling: true },
  { name: 'Beloit College', rankLabel: 'Liberal Rank #92', cats: [] },
  { name: 'Bennington College', rankLabel: 'Liberal Rank #121', cats: [] },
  ...
  { name: 'Bowling Green State University', rankLabel: 'National Rank #293', cats: [], enrolling: true },
  ...
  { name: 'Carson-Newman University', rankLabel: 'National Rank #358', cats: [] },
  ...
  { name: 'College of the Atlantic', rankLabel: 'Liberal Rank #126', cats: [] },
  ...
  { name: 'Creighton University', rankLabel: 'National Rank #117', cats: [] },
  { name: 'Crown College', cats: [] },
  { name: 'The College of Wooster', rankLabel: 'Liberal Rank #76', cats: [], enrolling: true },
  ...
  { name: 'Drake University', rankLabel: 'National Rank #183', cats: [] },
  ...
  { name: 'Florida Agricultural and Mechanical University', rankLabel: 'National Rank #169', cats: [] },
  ...
  { name: 'Franklin & Marshall College', rankLabel: 'Liberal Rank #35', cats: ['lac75'] },
  ...
  { name: 'Hampden-Sydney College', rankLabel: 'Liberal Rank #107', cats: [], enrolling: true },
  { name: 'Hampshire College', rankLabel: 'Liberal Rank #156', cats: [] },
  { name: 'Hampton University', rankLabel: 'National Rank #273', cats: ['hbcu'] },
  ...
  { name: 'Kean University', rankLabel: 'National Rank #318', cats: [] },
  { name: 'Kent State University', rankLabel: 'National Rank #232', cats: [] },
  ...
  { name: 'Lewis & Clark College', rankLabel: 'Liberal Rank #96', cats: [] },
  { name: 'Liberty University', rankLabel: 'National Rank #395-434', cats: [] },
  { name: 'Lipscomb University', rankLabel: 'National Rank #222', cats: [] },
  ...
  { name: 'Miami University', rankLabel: 'National Rank #143', cats: [], enrolling: true },
  ...
  { name: 'Missouri University of Science and Technology', rankLabel: 'National Rank #192', cats: [] },
  ...
  { name: 'North Carolina A & T State University', rankLabel: 'National Rank #232', cats: [], enrolling: true },
  ...
  { name: 'Pace University', rankLabel: 'National Rank #273', cats: [], enrolling: true },
  ...
  { name: 'Roanoke College', rankLabel: 'Liberal Rank #126', cats: [], enrolling: true },
  ...
  { name: 'Rowan University', rankLabel: 'National Rank #163', cats: [] },
  { name: 'Rutgers University (Camden)', rankLabel: 'National Rank #97', cats: [], enrolling: true },
  { name: 'Rutgers University (New Brunswick)', rankLabel: 'National Rank #42', cats: [], enrolling: true },
  ...
  { name: 'Samford University', rankLabel: 'National Rank #143', cats: [], enrolling: true },
  ...
  { name: 'Seattle University', rankLabel: 'National Rank #124', cats: [] },
  ...
  { name: 'SUNY College of Environmental Science and Forestry', rankLabel: 'National Rank #158', cats: [] },
  ...
  { name: 'Temple University', rankLabel: 'National Rank #102', cats: [], enrolling: true },
  ...
  { name: 'Texas Tech University', rankLabel: 'National Rank #198', cats: ['p4'] },
  { name: 'Thomas Jefferson University', rankLabel: 'National Rank #132', cats: [] },
  ...
  { name: 'University of California (Berkeley)', rankLabel: 'National Rank #15', cats: [], enrolling: true },
  ...
  { name: 'University of California (Los Angeles)', rankLabel: 'National Rank #17', cats: [] },
  { name: 'University of California (Riverside)', rankLabel: 'National Rank #75', cats: [] },
  { name: 'University of California (San Diego)', rankLabel: 'National Rank #29', cats: [], enrolling: true },
  ...
  { name: 'University of Cincinnati', rankLabel: 'National Rank #158', cats: ['p4'] },
  { name: 'University of Colorado Boulder', rankLabel: 'National Rank #97', cats: ['nu75', 'p4'], enrolling: true },
  ...
  { name: 'University of Denver', rankLabel: 'National Rank #117', cats: [], enrolling: true },
  ...
  { name: 'University of Maine', rankLabel: 'National Rank #257', cats: [] },
  ...
  { name: 'University of Missouri (Kansas City)', rankLabel: 'National Rank #232', cats: [] },
  { name: 'University of New England', cats: [] },
  { name: 'University of New Hampshire', rankLabel: 'National Rank #117', cats: [], enrolling: true },
  { name: 'University of North Carolina - Asheville', rankLabel: 'Liberal Rank #135', cats: [], enrolling: true },
  ...
  { name: 'University of North Carolina - Greensboro', rankLabel: 'National Rank #198', cats: [], enrolling: true },
  ...
  { name: 'University of Pittsburgh', rankLabel: 'National Rank #69', cats: ['nu75', 'p4'], enrolling: true },
  ...
  { name: 'University of South Alabama', rankLabel: 'National Rank #363', cats: [] },
  ...
  { name: 'University of Wisconsin', rankLabel: 'National Rank #36', cats: [], enrolling: true },
  { name: 'Valparaiso University', rankLabel: 'National Rank #198', cats: [] },
  ...
  { name: 'Wingate University', rankLabel: 'National Rank #373', cats: [], enrolling: true },
