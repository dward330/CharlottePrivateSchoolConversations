...
const colleges = [
  { name: 'Agnes Scott College', rankLabel: 'Liberal Rank #62', cats: ['lac75'] },
  { name: 'American University', rankLabel: 'National Rank #88', cats: [], enrolling: true },
  { name: 'Appalachian State University', cats: [], enrolling: true },
  { name: 'Arizona State University (Tempe)', rankLabel: 'National Rank #117', cats: [] },
  { name: 'Auburn University', rankLabel: 'National Rank #105', cats: ['p4'] },
  ...
  { name: 'Belmont University', rankLabel: 'National Rank #213', cats: [] },
  { name: 'Bentley University', cats: [] },
  { name: 'Boise State University', rankLabel: 'National Rank #301', cats: [] },
  { name: 'Boston College', rankLabel: 'National Rank #37', cats: ['nu75', 'p4'], enrolling: true },
  { name: 'Boston University', rankLabel: 'National Rank #41', cats: ['nu75'] },
  { name: 'Bowdoin College', rankLabel: 'Liberal Rank #5', cats: ['lac75'] },
  ...
  { name: 'Bucknell University', rankLabel: 'Liberal Rank #33', cats: ['lac75'] },
  ...
  { name: 'Campbell University', rankLabel: 'National Rank #343', cats: [] },
  ...
  { name: 'Catholic University of America', rankLabel: 'National Rank #169', cats: [] },
  { name: 'Central Piedmont Community College', cats: [] },
  { name: 'Chapman University', rankLabel: 'National Rank #110', cats: [] },
  ...
  { name: 'Colorado School of Mines', rankLabel: 'National Rank #80', cats: [], enrolling: true },
  { name: 'Colorado State University (Fort Collins)', rankLabel: 'National Rank #151', cats: [] },
  ...
  { name: 'Drew University', rankLabel: 'Liberal Rank #84', cats: [] },
  { name: 'Drexel University', rankLabel: 'National Rank #80', cats: [] },
  { name: 'Duke University', rankLabel: 'National Rank #7', cats: ['ivyplus', 'nu75', 'p4'], enrolling: true },
  { name: 'East Carolina University', rankLabel: 'National Rank #192', cats: [], enrolling: true },
  { name: 'East Tennessee State University', rankLabel: 'National Rank #301', cats: [] },
  { name: 'Eastern Michigan University', rankLabel: 'National Rank #373', cats: [] },
  { name: 'Eckerd College', rankLabel: 'Liberal Rank #135', cats: [] },
  { name: 'Elon University', rankLabel: 'National Rank #117', cats: [], enrolling: true },
  { name: 'Emerson College', cats: [] },
  { name: 'Emory & Henry College', cats: [] },
  { name: 'Emory University', rankLabel: 'National Rank #24', cats: ['nu75'] },
  ...
  { name: 'Florida Gulf Coast University', rankLabel: 'National Rank #318', cats: [] },
  ...
  { name: 'Franklin & Marshall College', rankLabel: 'Liberal Rank #35', cats: ['lac75'], enrolling: true },
  { name: 'Furman University', rankLabel: 'Liberal Rank #41', cats: ['lac75'] },
  { name: 'Gardner-Webb University', rankLabel: 'National Rank #384', cats: [] },
  ...
  { name: 'Georgia Institute of Technology', rankLabel: 'National Rank #33', cats: ['nu75', 'p4'], enrolling: true },
  { name: 'Georgia Southern University', rankLabel: 'National Rank #343', cats: [] },
  { name: 'Gettysburg College', rankLabel: 'Liberal Rank #53', cats: ['lac75'] },
  { name: 'Gonzaga University', cats: [] },
  { name: 'Goucher College', rankLabel: 'Liberal Rank #126', cats: [] },
  { name: 'Grace College', cats: [] },
  { name: 'Grand Canyon University', cats: [] },
  { name: 'Guilford College', rankLabel: 'Liberal Rank #172', cats: [] },
  { name: 'Hamilton College', rankLabel: 'Liberal Rank #15', cats: ['lac75'] },
  { name: 'Hampden-Sydney College', rankLabel: 'Liberal Rank #107', cats: [] },
  { name: 'Harvey Mudd College', rankLabel: 'Liberal Rank #25', cats: ['lac75'] },
  { name: 'High Point University', cats: [], enrolling: true },
  { name: 'Hofstra University', rankLabel: 'National Rank #183', cats: [] },
  { name: 'Hollins University', cats: [] },
  { name: 'Howard University', rankLabel: 'National Rank #88', cats: ['hbcu'] },
  { name: 'Indiana University (Bloomington)', rankLabel: 'National Rank #73', cats: [] },
  ...
  { name: 'Juniata College', rankLabel: 'Liberal Rank #92', cats: [] },
  { name: 'Kansas State University', rankLabel: 'National Rank #158', cats: ['p4'] },
  ...
  { name: 'Liberty University', rankLabel: 'National Rank #395-434', cats: [] },
  { name: 'Limestone University', cats: [] },
  { name: 'Longwood University', cats: [] },
  { name: 'Louisiana State University', rankLabel: 'National Rank #169', cats: ['p4'], enrolling: true },
  { name: 'Loyola Marymount University', rankLabel: 'National Rank #102', cats: [] },
  { name: 'Lynn University', cats: [] },
  { name: 'Macalester College', rankLabel: 'Liberal Rank #27', cats: ['lac75'] },
  ...
  { name: 'Miami University (Oxford)', rankLabel: 'National Rank #143', cats: [], enrolling: true },
  { name: 'Michigan State University', rankLabel: 'National Rank #63', cats: ['nu75', 'p4'] },
  { name: 'Michigan Technological University', rankLabel: 'National Rank #158', cats: [] },
  { name: 'Middle Tennessee State University', rankLabel: 'National Rank #257', cats: [], enrolling: true },
  { name: 'Middlebury College', rankLabel: 'Liberal Rank #11', cats: ['lac75'], enrolling: true },
  { name: 'Milligan University', cats: [], enrolling: true },
  { name: 'Mississippi State University', rankLabel: 'National Rank #208', cats: ['p4'] },
  { name: 'Monmouth University', cats: [] },
  { name: 'Montana State University', rankLabel: 'National Rank #318', cats: [] },
  { name: 'Muhlenberg College', rankLabel: 'Liberal Rank #70', cats: [] },
  { name: 'New Jersey Institute of Technology', rankLabel: 'National Rank #80', cats: [] },
  { name: 'New York University', rankLabel: 'National Rank #30', cats: ['nu75'] },
  { name: 'North Carolina A&T State University', rankLabel: 'National Rank #232', cats: ['hbcu'] },
  ...
  { name: 'Northeastern University', rankLabel: 'National Rank #47', cats: ['nu75'] },
  { name: 'Nova Southeastern University', rankLabel: 'National Rank #257', cats: [] },
  { name: 'Oberlin College', rankLabel: 'Liberal Rank #30', cats: ['lac75'] },
  { name: 'Old Dominion University', rankLabel: 'National Rank #293', cats: [] },
  { name: 'Oxford College of Emory University', cats: [] },
  { name: 'Palm Beach Atlantic University', rankLabel: 'National Rank #384', cats: [] },
  { name: 'Parsons School of Design at The New School', cats: [] },
  { name: 'Penn State University (University Park)', rankLabel: 'National Rank #59', cats: [], enrolling: true },
  { name: 'Penn State University (World Campus)', cats: [] },
  { name: 'Pepperdine University', rankLabel: 'National Rank #84', cats: [] },
  { name: 'Point Loma Nazarene University', cats: [] },
  { name: 'Point Park University', rankLabel: 'National Rank #318', cats: [] },
  { name: 'Portland State University', rankLabel: 'National Rank #222', cats: [] },
  { name: 'Pratt Institute', cats: [] },
  { name: 'Presbyterian College', rankLabel: 'Liberal Rank #163', cats: [] },
  { name: 'Providence College', cats: [] },
  { name: 'Purdue University', rankLabel: 'National Rank #46', cats: ['nu75', 'p4'] },
  { name: 'Queens University of Charlotte', cats: [] },
  { name: 'Quinnipiac University', rankLabel: 'National Rank #179', cats: [] },
  ...
  { name: 'Roanoke College', rankLabel: 'Liberal Rank #126', cats: [] },
  { name: 'Rochester Institute of Technology', rankLabel: 'National Rank #88', cats: [] },
  ...
  { name: 'Rutgers University (New Brunswick)', rankLabel: 'National Rank #42', cats: [] },
  { name: 'Saint Louis University', rankLabel: 'National Rank #102', cats: [] },
  { name: 'Saint Mary\'s College of California', cats: [] },
  { name: 'Salisbury University', cats: [] },
  { name: 'Samford University', rankLabel: 'National Rank #143', cats: [] },
  { name: 'San Diego State University', rankLabel: 'National Rank #109', cats: [] },
  { name: 'Santa Clara University', rankLabel: 'National Rank #59', cats: [] },
  { name: 'Savannah College of Art and Design', cats: [], enrolling: true },
  { name: 'School of the Art Institute of Chicago', cats: [] },
  { name: 'Seton Hall University', rankLabel: 'National Rank #158', cats: [] },
  { name: 'Sewanee: The University of the South', rankLabel: 'Liberal Rank #46', cats: ['lac75'], enrolling: true },
  { name: 'Southern Methodist University', rankLabel: 'National Rank #88', cats: ['p4'], enrolling: true },
  { name: 'Spelman College', rankLabel: 'Liberal Rank #39', cats: ['lac75', 'hbcu'] },
  { name: 'St. Bonaventure University', cats: [] },
  { name: 'St. John\'s University', rankLabel: 'National Rank #151', cats: [] },
  { name: 'Stanford University', rankLabel: 'National Rank #4', cats: ['ivyplus', 'nu75', 'p4'], enrolling: true },
  { name: 'Stetson University', cats: [] },
  { name: 'Stevens Institute of Technology', rankLabel: 'National Rank #80', cats: [] },
  { name: 'Stony Brook University', rankLabel: 'National Rank #59', cats: [] },
  { name: 'SUNY University at Buffalo', rankLabel: 'National Rank #75', cats: [] },
  { name: 'Syracuse University', rankLabel: 'National Rank #75', cats: ['nu75', 'p4'] },
  { name: 'Temple University', rankLabel: 'National Rank #102', cats: [] },
  ...
  { name: 'The New School', rankLabel: 'National Rank #213', cats: [], enrolling: true },
  { name: 'The Ohio State University', rankLabel: 'National Rank #43', cats: ['nu75', 'p4'] },
  { name: 'The University of Alabama', rankLabel: 'National Rank #105', cats: ['p4'] },
  ...
  { name: 'Tulane University of Louisiana', rankLabel: 'National Rank #69', cats: [], enrolling: true },
  ...
  { name: 'University of Alabama', rankLabel: 'National Rank #105', cats: ['p4'] },
  { name: 'University of Alabama at Birmingham', rankLabel: 'National Rank #132', cats: [] },
  { name: 'University of Alabama in Huntsville', rankLabel: 'National Rank #242', cats: [] },
  ...
  { name: 'University of California (Berkeley)', rankLabel: 'National Rank #15', cats: [] },
  { name: 'University of California (Davis)', rankLabel: 'National Rank #32', cats: [] },
  { name: 'University of California (Irvine)', rankLabel: 'National Rank #32', cats: [] },
  { name: 'University of California (Los Angeles)', rankLabel: 'National Rank #17', cats: [], enrolling: true },
  { name: 'University of California (San Diego)', rankLabel: 'National Rank #29', cats: [] },
  { name: 'University of California (Santa Barbara)', rankLabel: 'National Rank #40', cats: [] },
  { name: 'University of Central Florida', rankLabel: 'National Rank #117', cats: ['p4'] },
  { name: 'University of Charleston', rankLabel: 'National Rank #395-434', cats: [] },
  { name: 'University of Chicago', rankLabel: 'National Rank #6', cats: ['ivyplus', 'nu75'] },
  { name: 'University of Colorado (Colorado Springs)', rankLabel: 'National Rank #395-434', cats: [] },
  { name: 'University of Colorado Boulder', rankLabel: 'National Rank #97', cats: ['nu75', 'p4'] },
  { name: 'University of Connecticut', rankLabel: 'National Rank #75', cats: ['nu75'] },
  { name: 'University of Dayton', rankLabel: 'National Rank #143', cats: [] },
  { name: 'University of Delaware', rankLabel: 'National Rank #75', cats: ['nu75'] },
  { name: 'University of Denver', rankLabel: 'National Rank #117', cats: [] },
  ...
  { name: 'University of Hawaii at Manoa', rankLabel: 'National Rank #169', cats: [] },
  { name: 'University of Illinois at Chicago', rankLabel: 'National Rank #84', cats: [] },
  { name: 'University of Illinois at Urbana-Champaign', rankLabel: 'National Rank #69', cats: ['nu75', 'p4'] },
  { name: 'University of Kentucky', rankLabel: 'National Rank #124', cats: ['p4'] },
  { name: 'University of Louisville', rankLabel: 'National Rank #147', cats: ['p4'] },
  { name: 'University of Lynchburg', rankLabel: 'National Rank #329', cats: [] },
  { name: 'University of Mary Washington', rankLabel: 'Liberal Rank #131', cats: [] },
  { name: 'University of Maryland (College Park)', rankLabel: 'National Rank #42', cats: [] },
  { name: 'University of Massachusetts (Amherst)', rankLabel: 'National Rank #64', cats: [] },
  ...
  { name: 'University of Minnesota (Twin Cities)', rankLabel: 'National Rank #59', cats: [] },
  { name: 'University of Mississippi', rankLabel: 'National Rank #147', cats: ['p4'] },
  { name: 'University of Nebraska (Lincoln)', rankLabel: 'National Rank #158', cats: [] },
  { name: 'University of New Hampshire (Main Campus)', rankLabel: 'National Rank #117', cats: [] },
  { name: 'University of North Carolina at Asheville', rankLabel: 'Liberal Rank #135', cats: [], enrolling: true },
  { name: 'University of North Carolina at Chapel Hill', rankLabel: 'National Rank #26', cats: ['nu75', 'p4'], enrolling: true },
  { name: 'University of North Carolina at Charlotte', rankLabel: 'National Rank #143', cats: [], enrolling: true },
  { name: 'University of North Carolina at Greensboro', rankLabel: 'National Rank #198', cats: [], enrolling: true },
  ...
  { name: 'University of North Texas', rankLabel: 'National Rank #208', cats: [] },
  { name: 'University of Oklahoma', rankLabel: 'National Rank #124', cats: ['p4'] },
  { name: 'University of Oregon', rankLabel: 'National Rank #110', cats: ['p4'] },
  { name: 'University of Pennsylvania', rankLabel: 'National Rank #7', cats: ['ivy', 'ivyplus', 'nu75'], enrolling: true },
  { name: 'University of Pittsburgh (Pittsburgh)', rankLabel: 'National Rank #69', cats: [] },
  { name: 'University of Puget Sound', rankLabel: 'Liberal Rank #95', cats: [] },
  { name: 'University of Rhode Island', rankLabel: 'National Rank #151', cats: [] },
  { name: 'University of Richmond', rankLabel: 'Liberal Rank #18', cats: ['lac75'] },
  { name: 'University of Rochester', rankLabel: 'National Rank #51', cats: ['nu75'] },
  { name: 'University of San Francisco', rankLabel: 'National Rank #110', cats: [] },
  ...
  { name: 'University of South Florida (Main Campus)', rankLabel: 'National Rank #88', cats: [] },
  ...
  { name: 'University of Utah', rankLabel: 'National Rank #151', cats: ['p4'] },
  { name: 'University of Vermont', rankLabel: 'National Rank #132', cats: [], enrolling: true },
  { name: 'University of Virginia (Main Campus)', rankLabel: 'National Rank #26', cats: [], enrolling: true },
  { name: 'University of Washington (Seattle Campus)', rankLabel: 'National Rank #42', cats: [], enrolling: true },
  { name: 'University of Wisconsin (Madison)', rankLabel: 'National Rank #36', cats: [], enrolling: true },
  ...
  { name: 'Villanova University', rankLabel: 'National Rank #57', cats: ['nu75'], enrolling: true },
  { name: 'Virginia Commonwealth University', rankLabel: 'National Rank #139', cats: [], enrolling: true },
  { name: 'Virginia Military Institute', rankLabel: 'Liberal Rank #65', cats: [] },
  { name: 'Virginia Polytechnic Institute and State University', rankLabel: 'National Rank #47', cats: ['nu75', 'p4'], enrolling: true },
  { name: 'Virginia Wesleyan University', rankLabel: 'Liberal Rank #178', cats: [] },
  { name: 'Wake Forest University', rankLabel: 'National Rank #47', cats: ['nu75', 'p4'], enrolling: true },
  { name: 'Washington & Jefferson College', rankLabel: 'Liberal Rank #84', cats: [] },
  { name: 'Washington and Lee University', rankLabel: 'Liberal Rank #21', cats: ['lac75'] },
  ...
  { name: 'West Virginia University', rankLabel: 'National Rank #222', cats: ['p4'] },
  { name: 'Western Carolina University', rankLabel: 'National Rank #257', cats: [] },
  { name: 'Wheaton College - IL', rankLabel: 'Liberal Rank #50', cats: [] },
  { name: 'Wheaton College - MA', rankLabel: 'Liberal Rank #76', cats: [] },
  { name: 'William & Mary', rankLabel: 'National Rank #51', cats: ['nu75'] },
  { name: 'Wingate University', rankLabel: 'National Rank #373', cats: [] },
  { name: 'Winston-Salem State University', rankLabel: 'National Rank #232', cats: ['hbcu'] },
  { name: 'Winthrop University', cats: [] },
  { name: 'Wofford College', rankLabel: 'Liberal Rank #57', cats: ['lac75'], enrolling: true },
  { name: 'Worcester Polytechnic Institute', rankLabel: 'National Rank #84', cats: [] },
  { name: 'Xavier University', rankLabel: 'National Rank #208', cats: [] },
  { name: 'Arizona State University (Main Campus)', rankLabel: 'National Rank #117', cats: [], enrolling: true },
  { name: 'The College of William and Mary', cats: [], enrolling: true },
  { name: 'University of North Carolina Wilmington', rankLabel: 'National Rank #198', cats: [], enrolling: true },
]
