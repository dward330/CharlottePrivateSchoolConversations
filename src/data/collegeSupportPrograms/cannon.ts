...
const colleges = [
  ...
  { name: 'Franklin & Marshall College', rankLabel: 'Liberal Rank #48', cats: ['lac75'], enrolling: true },
  ...
  { name: 'University of North Carolina at Chapel Hill', rankLabel: 'National Rank #22', cats: ['nu75', 'p4'], enrolling: true },
