...
const colleges = [
  ...
  { name: 'Penn State University (University Park)', cats: ['nu75'], enrolling: true },
  ...
  { name: 'Rutgers University (New Brunswick)', cats: ['nu75'] },
  ...
  { name: 'SUNY University at Buffalo', cats: ['nu75'] },
  ...
  { name: 'University of Minnesota (Twin Cities)', cats: ['nu75'] },
  ...
  { name: 'University of Virginia (Main Campus)', cats: ['nu75'], enrolling: true },
  { name: 'University of Washington (Seattle Campus)', cats: ['nu75'], enrolling: true },
  { name: 'University of Wisconsin (Madison)', cats: ['nu75'], enrolling: true },
