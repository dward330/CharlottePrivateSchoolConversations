var e=`charlotte-catholic`,t=`financial-aid-tuition`,n=2,r=[{subtopic:`Schedule and Aid Programs 2026-2027`,source_file:`Charlotte Catholic - Financial Aid & Tuition - Schedule and Aid Programs 2026-2027.md`,preview:`# Charlotte Catholic High School — Financial Aid & Tuition (Schedule and Aid Programs 2026-2027) - School: Charlotte Catholic High School, grades 9–12, part of Mecklenburg Area Catholic Schools (MACS), Diocese of Charlotte. ### ⚠️ Tuition is set centrally by MACS, not by the school Unlike every independent school on…`,text:`# Charlotte Catholic High School — Financial Aid & Tuition (Schedule and Aid Programs 2026-2027)
...
- **\`tuition-history\` — not published.** MACS publishes only the **current** year's
 ...
 path if this row is ever wanted.`},{subtopic:`Fees`,source_file:null,preview:`| Fee | Amount | | --- | --- | | Application fee | $120 per student | | Continuous enrollment fee | $150 per returning student | | Capital fee | $1,995 per family | | FACTS payment plan fee | $15–$45 per family | Note the capital fee is charged per family, not per student — so it does not scale with the number of…`,text:`| Fee | Amount |
| --- | --- |
