var e=`trinity-episcopal`,t=`admissions`,n=17,r=[{subtopic:`Application Process and Testing`,source_file:`Trinity Episcopal School - Admissions - Application Process and Testing.md`,preview:`# Trinity Episcopal School — Admissions — Application Process and Testing`,text:`# Trinity Episcopal School — Admissions — Application Process and Testing`},{subtopic:`Source URLs`,source_file:null,preview:`- Admission process — https://www.tescharlotte.org/admission/admission-process.cfm - Admission events and tours — https://www.tescharlotte.org/admission/admission-events-and-tours.cfm - Admission team — https://www.tescharlotte.org/admission/`,text:`- Admission process — https://www.tescharlotte.org/admission/admission-process.cfm
- Admission events and tours — https://www.tescharlotte.org/admission/admission-events-and-tours.cfm
- Admission team — https://www.tescharlotte.org/admission/`},{subtopic:`⚠️⚠️ THREE NON-ALIGNED GRADE SPLITS — the sentence most likely to be written wrongly`,source_file:null,preview:`Trinity's admissions bands do not line up with each other, and the natural simplifying sentence is false. | Split | Boundary | Bands | |---|---|---| | Deadlines and decisions | K vs 1 | K / 1–8 | | Testing instrument | 1 vs 2, and 4 vs 5 | K–1 / 2–4 / 5–8 | | Administering body | 4 vs 5 | CAIS (K–4) / ISEE (5–8) | > ⛔…`,text:`Trinity's admissions bands **do not line up with each other**, and the natural
...
> "Complete testing: **CAIS (K-4) and ISEE (5-8)**"`},{subtopic:`The 2027-28 cycle — and the label agrees with the dates`,source_file:null,preview:`Verbatim: > "The deadlines to apply for the 2027-28 school year are:" | Stage | Kindergarten | Grades 1–8 | |---|---|---| | Application deadline | January 2, 2027 | January 15, 2027 | | Supporting materials | February 1, 2027 | February 26, 2027 | | Decisions emailed | Friday, February 26, 2027 | Friday, April 9, 2027…`,text:`Verbatim:
...
> prospective-family financial-aid deadline.`},{subtopic:`Portal, visits and recommendations`,source_file:null,preview:`Portal: FACTS — "Setup your FACTS admission account", "Submit the application and application fee". Site-wide navigation carries "FACTS Family Portal". There is no Ravenna anywhere on this site. Wildcat Visit Day, verbatim: > "Applicants will be invited to register to spend the day on campus (rising 1st-8th) or >…`,text:`**Portal: FACTS** — "Setup your FACTS admission account", "Submit the application and
...
prefiere comunicarse en español, póngase en contacto con Fé Patriciu."`},{subtopic:`Open houses — and two school-side errors`,source_file:null,preview:`| Event | Date as printed | Weekday check | process.cfm time | events-and-tours.cfm time | |---|---|---|---|---| | Kindergarten Open House | "Tuesday, Sept. 29, 2026" | ✅ correct | 9:30 – 11:00 a.m. | 9:30-11:00 a.m. | | K–8 Open House | "Thursday, Nov. 5, 2026" | ✅ correct | 9:30 – 11:00 a.m. | 9:30-11:00 a.m. | |…`,text:`| Event | Date as printed | Weekday check | process.cfm time | events-and-tours.cfm time |
|---|---|---|---|---|
...
Open houses are held "in **Trinity's Center for Community and the Arts**".`},{subtopic:`A third date error — the stale financial-aid deadline`,source_file:null,preview:`The process page states, verbatim: > "The financial support application deadline for prospective families is Thursday, > February 1, 2026." This is a year stale (the tuition page says Feb. 1, 2027), and Feb 1 2026 is a Sunday, not a Thursday. The root cause is traceable: the 2026-05-09 archived snapshot shows the…`,text:`The process page states, verbatim:
...
**Every other date on the process page is correctly 2027.** Only the aid line is stale.`},{subtopic:`⛔ Confirmed absent`,source_file:null,preview:`| Item | Status | |---|---| | Application fee amount | Confirmed absent. The checklist says "Submit the application and application fee" and never states a figure. \`grep -o '\\$[0-9][0-9,.]*'\` over the entire raw HTML returns zero dollar signs on the page. | | Acceptance rate | Confirmed absent — not on the site, not…`,text:`| Item | Status |
|---|---|
...
---`},{subtopic:`CAIS Consortium`,source_file:`Trinity Episcopal School - Admissions - CAIS Consortium.md`,preview:`# Trinity Episcopal School — Admissions — CAIS Consortium`,text:`# Trinity Episcopal School — Admissions — CAIS Consortium`},{subtopic:`Source URL`,source_file:null,preview:`- https://www.tescharlotte.org/editoruploads/files/CAIS2024-25final.pdf`,text:`- https://www.tescharlotte.org/editoruploads/files/CAIS2024-25final.pdf`},{subtopic:`⚠️ This is the 2024-25 edition — its STRUCTURE carries forward, its DATES do not`,source_file:null,preview:`The cover reads "2024-2025" and its inner dates run December 2023 – April 2024. Carries forward: the seven members, the two instruments and their grade bands, the $275 testing fees, the coaching/re-testing invalidation rule, the common notification-and-reply structure, and the no-contract-before-deadline guarantee.…`,text:`The cover reads "2024-2025" and its inner dates run December 2023 – April 2024.
...
/ 1–8 Jan 15 — a further reason not to reuse these dates as current.`},{subtopic:`The seven members`,source_file:null,preview:`Verbatim from the brochure's own eligibility list: 1. Charlotte Christian School 2. Charlotte Country Day School 3. Charlotte Latin School 4. Charlotte Preparatory School 5. Covenant Day School 6. Providence Day School 7. Trinity Episcopal School > Five of the seven have dossiers in this app. Charlotte Preparatory…`,text:`Verbatim from the brochure's own eligibility list:
...
> is a 2024-25 document and its contact is stale. Do not cite her as current staff.`},{subtopic:`The testing instruments`,source_file:null,preview:`Verbatim: > "They are the Wechsler Preschool and Primary Scale of Intelligence–Fourth Edition > (WPPSI-IV) for Pre-K, Kindergarten, and Grade 1 applicants; and the Wechsler > Intelligence Scale for Children–Fifth Edition (WISC-V) for rising Grades 2-4." This is consistent with Trinity's own "Grades K-1 / Grades 2-4"…`,text:`Verbatim:
...
> "Testing Fees: **$275** for WPPSI-IV / **$275** for WISC-V"`},{subtopic:`⚠️ The invalidation rule — the single most consequential policy here`,source_file:null,preview:`Verbatim, and it appears twice in the brochure: > "Psychologists will report to the schools any indication that a child has been > coached, tutored, or re-tested. Any indication of the aforementioned will > invalidate your application to any CAIS school. Parents will be asked to sign a > Test Validity Verification…`,text:`Verbatim, and it appears **twice** in the brochure:
...
at *every* CAIS school, which is materially different from a single school's rule.`},{subtopic:`Other policies, verbatim`,source_file:null,preview:`> "children must be at least four years of age at the time of testing, and the > assessment can be administered only once in a twelve month period." > "Please schedule with only one psychologist." / "Book an appointment with one > psychologist ONLY." > "In addition to the assessment, CAIS schools require an interview…`,text:`> "children must be **at least four years of age at the time of testing**, and the
...
> appointment."`},{subtopic:`Common notification and reply dates — the STRUCTURE`,source_file:null,preview:`Verbatim (2024-25 edition dates — stale, quoted for structure only): > "TK/JK/K for all CAIS schools: Notification date is Friday, February 23, 2024. Contracts > must be returned by Friday, March 1, 2024." > "Grades 1-4 for all CAIS schools: Notification date is Friday, March 28, 2024. Contracts > must be returned by…`,text:`Verbatim (2024-25 edition dates — **stale, quoted for structure only**):
...
hand before the others have replied.`},{subtopic:`What this means for a Trinity applicant, by grade`,source_file:null,preview:`| Applying to | Instrument | Administered by | Fee | |---|---|---|---| | K–1 | WPPSI-IV | CAIS consortium psychologist | $275 | | 2–4 | WISC-V | CAIS consortium psychologist | $275 | | 5–8 | ISEE | Not CAIS — the ISEE is a separate exam | (no CAIS fee) | Grades 5–8 sit outside the CAIS testing arrangement entirely.…`,text:`| Applying to | Instrument | Administered by | Fee |
|---|---|---|---|
