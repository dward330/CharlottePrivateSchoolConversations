var e=`hickory-grove-christian`,t=`course-offerings`,n=9,r=[{subtopic:`Curriculum Guide`,source_file:`Hickory Grove Christian - Course Offerings - Curriculum Guide.md`,preview:"# Hickory Grove Christian School — Course Offerings **Provenance** - **Compiled by:** Claude Code deep research pass (`/implement add-hickory-grove-christian`). - **Date compiled:** 2026-08-17 - **School / guide year:** Hickory Grove Christian School (HGCS), Charlotte NC — High School (grades 9–12). Guide year…",text:`# Hickory Grove Christian School — Course Offerings
...
**Total 27 units.**`},{subtopic:`Per-department course enumeration (High School / Upper School, 2025-2026)`,source_file:null,preview:'**STATUS: BLOCKED — the school does not publish a machine-readable course catalog.** The "2025-2026 Course Selection Guide" (S4) renders its course list only through a client-side Finalsite widget; the live page, its Wayback 2025-10-28 snapshot, and an `X-Requested-With` API fetch all return **site chrome with an…',text:`**STATUS: BLOCKED — the school does not publish a machine-readable course catalog.** The
...
- **Electives** (4 units) — "a variety of electives" (S5); also AP Seminar + AP Research
 (AP Capstone), AP Computer Science A (named 2023-24). *Full elective list not published.*`},{subtopic:`Flags`,source_file:null,preview:`- **NOT EXTRACTABLE (SPA-blocked):** the full per-department course catalog and any exact total HS-course count — the Course Selection Guide is a JS/Finalsite SPA with an empty static body and no PDF/archive equivalent. - **NOT PUBLISHED (number):** honors course count; individual honors/regular course titles. - **TO…`,text:`- **NOT EXTRACTABLE (SPA-blocked):** the full per-department course catalog and any exact
