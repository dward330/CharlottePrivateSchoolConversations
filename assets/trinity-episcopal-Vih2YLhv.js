var e=`trinity-episcopal`,t=`financial-aid-tuition`,n=22,r=[{subtopic:`Financial Support`,source_file:`Trinity Episcopal School - Financial Aid and Tuition - Financial Support.md`,preview:`# Trinity Episcopal School — Financial Aid and Tuition — Financial Support`,text:`# Trinity Episcopal School — Financial Aid and Tuition — Financial Support`},{subtopic:`Source URLs`,source_file:null,preview:`- Tuition & affordability — https://www.tescharlotte.org/admission/tuition-affordability.cfm - Admission process — https://www.tescharlotte.org/admission/admission-process.cfm - 2026-27 School Profile (PDF) — https://www.tescharlotte.org/editoruploads/files/26-27SchoolProfile.pdf - Archived tuition pages —…`,text:`- Tuition & affordability — https://www.tescharlotte.org/admission/tuition-affordability.cfm
...
- Archived tuition pages — https://web.archive.org/web/timemap/link/https://www.tescharlotte.org/admission/tuition-affordability.cfm`},{subtopic:`The headline figures — 2026-27`,source_file:null,preview:'From the 2026-27 School Profile, verbatim: > "Financial Support Recipients: 31% of students (excludes Tuition Remission)" > "Financial Support Awards: $2,139,114" Context from the same document: operating budget `$11.09 million`, enrollment 419, faculty/staff 59 faculty, 28 administrative, 7 extended day & support. So…',text:`From the 2026-27 School Profile, verbatim:
...
not a published one; present the two figures, not the quotient.`},{subtopic:`A three-point aid series — and the school has since DELETED its own statistic`,source_file:null,preview:`Archived tuition pages carried a sentence the live page no longer has (grep for "awarded" on today's page: 0 hits): > (2023-09 → 2025-01) "In the 2023-24 school year, we awarded $2.1 million in > financial support to 26% of our students." > (2025-09 → 2026-05) "In the 2025-26 school year, we awarded $2 million in >…`,text:`Archived tuition pages carried a sentence the **live page no longer has** (grep for
...
own trajectory runs 26% → 29% → 31%.`},{subtopic:`How to apply`,source_file:null,preview:'Platform: Clarity. Verbatim: > "All qualified families may apply for financial support through Clarity." > "Financial awards are based on demonstrated need as assessed by Clarity. The > application for financial support has no bearing on admission." Portal: `app.clarityapp.com`. The school also links a "2026-27…',text:`**Platform: Clarity.** Verbatim:
...
**Trust the tuition page. Flag the discrepancy; do not silently fix it.**`},{subtopic:`A separate funding route — NC Opportunity Scholarship`,source_file:null,preview:`Verbatim: > "Trinity Episcopal School is acutely aware of the challenges of paying tuition and has > an additional option for you to explore beyond financial support. Please visit the > NC Opportunity Scholarship Program website to see if your family qualifies for this > resource through the North Carolina State…`,text:`Verbatim:
...
Promoted as a distinct route, not as part of the school's own aid.`},{subtopic:`⛔ Confirmed absent`,source_file:null,preview:`- Average award size — no source anywhere. - Enrollment deposit — zero hits. - Application fee amount — zero dollar signs on the entire process page. - Any aid figure for grades separately — aid is reported school-wide only. ---`,text:`- **Average award size** — no source anywhere.
...
---`},{subtopic:`Form 990`,source_file:`Trinity Episcopal School - Financial Aid and Tuition - Form 990.md`,preview:`# Trinity Episcopal School — Financial Aid and Tuition — Form 990`,text:`# Trinity Episcopal School — Financial Aid and Tuition — Form 990`},{subtopic:`Source URLs`,source_file:null,preview:'- https://projects.propublica.org/nonprofits/organizations/562059568 - https://projects.propublica.org/nonprofits/api/v2/organizations/562059568.json > ⚠️ ProPublica\'s `download-filing?path=…` PDF endpoint is blocked by a "Security > Check" interstitial — it returns a ~1.3 MB HTML challenge page, not a PDF. The HTML >…',text:`- https://projects.propublica.org/nonprofits/organizations/562059568
...
---`},{subtopic:`School Profile 2026-27`,source_file:`Trinity Episcopal School - Financial Aid and Tuition - School Profile 2026-27.md`,preview:`# Trinity Episcopal School — Financial Aid and Tuition — School Profile 2026-27`,text:`# Trinity Episcopal School — Financial Aid and Tuition — School Profile 2026-27`},{subtopic:`Source URLs`,source_file:null,preview:`- 2026-27 edition — https://www.tescharlotte.org/editoruploads/files/26-27SchoolProfile.pdf (841,498 bytes, retrieved 2026-09-16) - 2025-26 edition — https://www.tescharlotte.org/editoruploads/files/25-26SchoolProfile.pdf (156,683 bytes, retrieved 2026-09-16)`,text:`- **2026-27 edition** — https://www.tescharlotte.org/editoruploads/files/26-27SchoolProfile.pdf
 (841,498 bytes, retrieved 2026-09-16)
- **2025-26 edition** — https://www.tescharlotte.org/editoruploads/files/25-26SchoolProfile.pdf
 (156,683 bytes, retrieved 2026-09-16)`},{subtopic:`⚠️ WHY THIS FILE EXISTS — the URL is versioned and the old one 404s`,source_file:null,preview:`The School Profile is the single richest source on this school, and its URL is versioned by school year. When the 27-28 edition ships, the 26-27 URL will 404. The 24-25 edition and earlier are already gone from the live site, and only the 25-26 was ever archived. It is linked from one place only — the Middle School…`,text:`**The School Profile is the single richest source on this school**, and its URL is
...
or the athletics-by-season list depends on this capture.`},{subtopic:`⚠️ A known error in the 25-26 edition`,source_file:null,preview:"The 2025-26 profile states `Tuition ('25-'26): $25,400 (K-5); $25,771 (6-8)`. `$25,771` is the 2024-25 grade 6–8 figure — the PDF carried the prior year forward. The school's own tuition page said `$27,320` for 2025-26. See the Tuition and Fees file. Never cite this PDF for grade 6–8 tuition.",text:"The 2025-26 profile states `Tuition ('25-'26): $25,400 (K-5); $25,771 (6-8)`.\n**`$25,771` is the 2024-25 grade 6–8 figure** — the PDF carried the prior year forward.\nThe school's own tuition page said **`$27,320`** for 2025-26. See the Tuition and Fees\nfile. **Never cite this PDF for grade 6–8 tuition.**"},{subtopic:`⚠️ The asterisks are unexplained`,source_file:null,preview:"41 of 99 high schools and 71 of 160 colleges carry a trailing asterisk. No legend exists anywhere in the document — searched and confirmed absent. Publish no interpretation. The destination lists themselves are transcribed in `high-school-placement/trinity-episcopal/… Where They Land.md`. ---",text:`41 of 99 high schools and 71 of 160 colleges carry a trailing asterisk. **No legend
...
---`},{subtopic:`Verbatim text — 2026-27 edition`,source_file:null,preview:"The destination lists are omitted here (they run to 259 entries and are transcribed in the Where They Land file); everything preceding them is reproduced exactly. ``` 2026-2027 School Profile Trinity Episcopal School is committed to the breadth of the Episcopal tradition in both its unity and diversity. A student of…",text:`The destination lists are omitted here (they run to 259 entries and are transcribed in
...
---`},{subtopic:`Verbatim text — 2025-26 edition`,source_file:null,preview:"Captured for the longitudinal figures. Note the tuition error above. ``` 2025-2026 SCHOOL PROFILE Trinity Episcopal School is committed to the breadth of the Episcopal tradition in both its unity and diversity. A student of Trinity is challenged to academic excellence while honored as an individual with unique…",text:`Captured for the longitudinal figures. Note the tuition error above.
...
---`},{subtopic:`Year-over-year comparison`,source_file:null,preview:`| | 2025-26 | 2026-27 | |---|--:|--:| | Enrollment | 433 | 419 | | Tuition K-5 | $25,400 | $26,670 | | Tuition 6-8 | ⚠️ PDF says $25,771; the tuition page said $27,320 | $28,690 | | Financial support recipients | 28.9% | 31% | | Financial support awards | $2 million | $2,139,114 | | Operating budget | $11.09 million |…`,text:`| | 2025-26 | 2026-27 |
|---|--:|--:|
| Enrollment | 433 | **419** |
...
---`},{subtopic:`Tuition and Fees`,source_file:`Trinity Episcopal School - Financial Aid and Tuition - Tuition and Fees.md`,preview:`# Trinity Episcopal School — Financial Aid and Tuition — Tuition and Fees`,text:`# Trinity Episcopal School — Financial Aid and Tuition — Tuition and Fees`},{subtopic:`School Profile — per-grade cost table, 2026-27`,source_file:null,preview:`From "Cost of Attendance for 2026-27", verbatim: | Grade | Tuition | Activity Fee | |---|--:|--:| | K | $26,670 | $210 | | 1 | $26,670 | $225 | | 2 | $26,670 | $225 | | 3 | $26,670 | $305 | | 4 | $26,670 | $545 | | 5 | $26,670 | $735 | | 6 | $28,690 | $965 | | 7 | $28,690 | $965 | | 8 | $28,690 | $1,045 | ---`,text:`From "Cost of Attendance for 2026-27", verbatim:

| Grade | Tuition | Activity Fee |
|---|--:|--:|
| K | $26,670 | $210 |
| 1 | $26,670 | $225 |
| 2 | $26,670 | $225 |
