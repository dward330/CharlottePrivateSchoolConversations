var e=`cannon`,t=`course-offerings`,n=7,r=[{subtopic:`Curriculum Guide`,source_file:`Cannon - Course Offerings - Curriculum Guide.md`,preview:`# Cannon School — Course Offerings Provenance - Compiled by: Claude Code deep research pass, at Derrick's request - Date compiled: 2026-07-26 - Method: Web search plus direct download and local text extraction (pypdf) of Cannon's own 2026-27 Upper School Course Catalog and 2025-26 school profile, plus the live…`,text:`# Cannon School — Course Offerings
...
- **Extraction note:** both PDFs failed WebFetch parsing (returned as binary/compressed streams).
 ...
 "T opics", "W orld"); these were corrected against the catalog's own usage.`},{subtopic:`Source URLs`,source_file:null,preview:`| Ref | URL | What it covers | | --- | --- | --- | | S1 | https://resources.finalsite.net/images/v1769529893/cannonschoolorg/ihl0lzuqgs9loqntga7z/CannonAcademicCourseCatalog2026-2027.pdf | PRIMARY SOURCE — "Upper School Course Catalog 2026-2027" (44 pp.). Every Upper School course with full catalog descriptions,…`,text:`| Ref | URL | What it covers |
| --- | --- | --- |
...
**Publication year:** the Upper School catalog is the **2026-27** edition; the profile is **2025-26**.`},{subtopic:`Metrics`,source_file:null,preview:`| Metric | Value | Source | | --- | --- | --- | | Grade range | JrK–Grade 12 | S2, S6, S12 | | Upper School courses catalogued | 104 (counted from the 2026-27 catalog's 11 course-offering sections) | S1 | | Upper School academic departments | 8 (English, Arts, Mathematics, Science, Social Studies, World Languages,…`,text:`| Metric | Value | Source |
| --- | --- | --- |
...
(incl. Biology or Principles of Life Science) · Arts 2 yrs · PE 1 yr (or athletic participation).`},{subtopic:`Upper School (Grades 9–12) — source S1`,source_file:null,preview:`### English - Honors English I — Gr 9 — A foundational course cultivating critical thinking, analytical skills, and creative expression across memoirs, plays, novels, poetry, and short stories. - Honors English II: Reading and Discourse — Gr 10 — A sophomore seminar-style class reading and discussing influential…`,text:`### English
...
- **Global Education Certificate** — requires Level III+ language plus Honors Glocal Perspectives.`},{subtopic:`Middle School (Grades 5–8) — sources S12–S16`,source_file:null,preview:`Cannon publishes Middle School curriculum as per-grade subject descriptions, not a named-course catalog. Core subjects are consistent across grades; the real course-level variation is in math tracking, world language, and arts. ### Core academics - English — Gr 5-8 — Grade 5 explores genres and writing critically;…`,text:`Cannon publishes Middle School curriculum as **per-grade subject descriptions, not a named-course
...
makerspace.`},{subtopic:`Lower School (JrK–Grade 4) — sources S6–S11`,source_file:null,preview:`Cannon publishes 12 named curriculum areas consistently for Grades 1–4, plus named commercial programs. There is no course catalog — this is the correct grain of published data. - Language Arts — Gr 1-4 — A literacy block integrating whole-class and small-group differentiated instruction across phonics, fluency,…`,text:`Cannon publishes **12 named curriculum areas** consistently for Grades 1–4, plus named commercial
...
keyboarding, creative mixed media, presentations, and research skills.`},{subtopic:`Gaps — what Cannon does not publish`,source_file:null,preview:`1. No Middle School course catalog. Grades 5–8 are published as prose subject descriptions per grade (S13–S16), not as a titled course list with descriptions. There is no Middle School equivalent of the 44-page Upper School catalog. 2. No Lower School course catalog. JrK–4 is published as 12 named curriculum areas per…`,text:`1. **No Middle School course catalog.** Grades 5–8 are published as prose subject descriptions per
