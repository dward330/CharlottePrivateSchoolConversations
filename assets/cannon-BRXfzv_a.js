var e=`cannon`,t=`course-offerings`,n=7,r=[{subtopic:`Curriculum Guide`,source_file:`Cannon - Course Offerings - Curriculum Guide.md`,preview:"# Cannon School — Course Offerings - Divisions: Lower School JrK–4 · Middle School 5–8 · Upper School 9–12 - Extraction note: both PDFs failed WebFetch parsing (returned as binary/compressed streams). They were downloaded with `curl` and extracted locally with `pypdf`. Re-verification should use that path, not…",text:`# Cannon School — Course Offerings
