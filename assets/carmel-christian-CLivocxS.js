var e=`carmel-christian`,t=`course-offerings`,n=16,r=[{subtopic:`Curriculum Guide`,source_file:`Carmel Christian - Course Offerings - Curriculum Guide.md`,preview:`# Carmel Christian School — Course Offerings - Divisions: High School (grades 9–12) AND Middle School (grades 6–8), both published as named course lists. Lower School (K–5) is NOT a named course list — the elementary academics pages describe subject areas only (Bible, Math, Language Arts, Science, Social Studies, Art,…`,text:`# Carmel Christian School — Course Offerings
...
(weighted) = 5/4/3/1/0. Grading scale A 90–100 / B 80–89 / C 70–79 / D 60–69 / F ≤59.`},{subtopic:`Middle School catalog (grades 6–8, verbatim)`,source_file:null,preview:'Source: MS Curriculum page `https://carmelchristian.org/apps/pages/index.jsp?uREC_ID=487132&type=d&pREC_ID=935888` (linked "2024-2025 MS Curriculum Guide" Calaméo at `https://www.calameo.com/read/00320361962a97fb5020d`). Spelling preserved exactly as published — note "Spanish 1-A" (Arabic 1) but "Spanish I-B" (Roman…',text:`Source: **MS Curriculum page** \`https://carmelchristian.org/apps/pages/index.jsp?uREC_ID=487132&type=d&pREC_ID=935888\`
...
---`},{subtopic:`Elementary Curriculum Guide`,source_file:`Carmel Christian - Course Offerings - Elementary Curriculum Guide.md`,preview:`# Carmel Christian School — Course Offerings — Elementary Curriculum Guide - Source document: "Carmel Christian School — 2026-2027 Elementary School Course Description Guide" (cover dated 2026-2027; running footer reads "2025-2026 Elementary School Curriculum Guide"). 12 pp. Provided directly by the user as a PDF. -…`,text:`# Carmel Christian School — Course Offerings — Elementary Curriculum Guide
...
Carolina history through Reconstruction (Gr 4) → early American history 1400s–1880s (Gr 5).`},{subtopic:`Special Areas (All Grades, from the guide)`,source_file:null,preview:`- Art — foundational construction skills (painting, drawing, cutting, collage); elements of art, art vocabulary, self-assessment; biblical integration of creativity. - Spanish — complex language concepts via songs/games/literature/art/technology across the three modes of communication (interpretive, interpersonal,…`,text:`- **Art** — foundational construction skills (painting, drawing, cutting, collage); elements
