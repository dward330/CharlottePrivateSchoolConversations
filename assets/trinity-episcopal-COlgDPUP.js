var e=`trinity-episcopal`,t=`high-school-placement`,n=22,r=[{subtopic:`Placement Outcomes`,source_file:`Trinity Episcopal School - High School Placement - Placement Outcomes.md`,preview:`# Trinity Episcopal School — High School Placement — Placement Outcomes`,text:`# Trinity Episcopal School — High School Placement — Placement Outcomes`},{subtopic:`Source URLs`,source_file:null,preview:`- 2026-27 School Profile (PDF) — https://www.tescharlotte.org/editoruploads/files/26-27SchoolProfile.pdf - 2025-26 School Profile (PDF) — https://www.tescharlotte.org/editoruploads/files/25-26SchoolProfile.pdf - Class of 2026 — https://www.tescharlotte.org/blog.cfm?threadid=48 - Class of 2025 —…`,text:`- 2026-27 School Profile (PDF) — https://www.tescharlotte.org/editoruploads/files/26-27SchoolProfile.pdf
...
> capture is why the longitudinal rows below remain citable.`},{subtopic:`The cumulative split — Trinity's headline placement figure`,source_file:null,preview:`Verbatim from the 2026-27 profile: > "Trinity graduated its first eighth-grade class in June 2004. A total of 1,060 > students have graduated over the past 23 years (Class of 2004-2026). Over the years, > our alumni have chosen the following: > Independent Schools: 31% • Public Schools: 57% • Boarding Schools: 12%" ⚠️…`,text:`Verbatim from the **2026-27** profile:
...
published size exactly — an internal consistency check that passes.`},{subtopic:`Per-class series`,source_file:null,preview:`Every row below is first-party and carries its denominator. | Class | Graduates | "Lifers" | Lifer rate | Distinct high schools | Named list published? | |---|--:|--:|--:|--:|---| | 2023 | 49 | not published | — | 11 | No — count only | | 2024 | 51 | 9 | 18% | 17 (+ schools in 3 other states) | No — count only | |…`,text:`Every row below is first-party and carries its denominator.
...
> beginning of their next chapters at **11 different schools**."`},{subtopic:`⚠️ Trinity publishes NO placement success rate — a confirmed, deliberate null`,source_file:null,preview:`This is the single most important negative in this topic, and the sharpest difference from a school whose placement data looks superficially similar. Swept across all 100 sitemap pages + all 51 blog posts + both profile PDFs (1,637,243 characters): | Term | Hits | |---|--:| | "first choice" / "first-choice" | 0 | |…`,text:`This is the single most important negative in this topic, and the sharpest difference
...
**No high school merit scholarship counts or dollars are published either.**`},{subtopic:`⚠️ Data-quality defects in the school's own sources — preserve, do not silently fix`,source_file:null,preview:'1. The Class of 2026 list prints "Myers Park High School" twice. 11 bullets, 10 distinct schools. Verified in the raw HTML `<li>` sequence, at positions 1 and 7. Items 2–11 are alphabetical and the leading entry breaks that order, so it reads as an editing slip where a first entry was never deleted. Publish as 10…',text:`1. **The Class of 2026 list prints "Myers Park High School" twice.** 11 bullets,
 ...
 **Sommers Errington**; the June 2026 commencement post names **Eugene Brown** (the
 25-26 profile says Eugene J. Brown). One is stale; the profile is the later document.`},{subtopic:`The K–8 thesis — the school's own framing of why placement happens at 8th grade`,source_file:null,preview:`From \`/admission/k-8-advantage.cfm\`, section heading "Choosing the Right High School - At the Right Time": > "Trinity's teachers and administrators have a unique perspective on students' growth > and development… But in those nine years, parents and teachers garner invaluable insight > about the child's interests,…`,text:`From \`/admission/k-8-advantage.cfm\`, section heading **"Choosing the Right High School -
At the Right Time"**:
...
---`},{subtopic:`The Placement Program`,source_file:`Trinity Episcopal School - High School Placement - The Placement Program.md`,preview:`# Trinity Episcopal School — High School Placement — The Placement Program`,text:`# Trinity Episcopal School — High School Placement — The Placement Program`},{subtopic:`Source URLs`,source_file:null,preview:`- The counselor article — https://www.tescharlotte.org/blog.cfm?threadid=6 (⚠️ see the title-swap note below — this is NOT the post titled about counselors) - Staculty directory — https://www.tescharlotte.org/about/faculty-staff-directory.cfm - Admission team — https://www.tescharlotte.org/admission/ - The K-8…`,text:`- **The counselor article** — https://www.tescharlotte.org/blog.cfm?threadid=6
...
- Advocacy panel — https://www.tescharlotte.org/blog.cfm?threadid=40`},{subtopic:`⚠️ A CMS defect: two blog posts have their titles SWAPPED`,source_file:null,preview:`This matters because the obvious search lands on the wrong document. | threadid | Title as published | What the body actually is | |---|---|---| | 7 | "High School Counselors Help Families Navigate Next Step" | the Fé Patriciu hiring announcement | | 6 | "Trinity Featured in QCityMetro" | the actual…`,text:`This matters because the obvious search lands on the wrong document.
...
commencement story, #2 is a staff retirement tribute.`},{subtopic:`The program, as the school describes it`,source_file:null,preview:"From the school's own admission page (`/admission/k-8-advantage.cfm`), verbatim: > \"Trinity's two high school counselors work closely with families and students to sift > through the many options available for the next chapter in their education, whether it's > in a public school, another independent institution, or a…",text:`From the school's own admission page (\`/admission/k-8-advantage.cfm\`), verbatim:
...
> consider pursuing it and exploring it."`},{subtopic:`⚠️ Who holds these roles TODAY — the 2023 article is stale on staffing`,source_file:null,preview:`Benita Griffin no longer appears in the staculty directory at all. She is named as the boarding counselor in the Sep 2023 article and as "Interim Director of Admission & Financial Support" in the CAIS brochure. Do not cite her as current staff. Current, as of the 2026-09-16 fetch: | Person | Role | Scope |…`,text:`**Benita Griffin no longer appears in the staculty directory at all.** She is named as
...
high school counselors" count is Clark + Wise only.`},{subtopic:`Related 8th-grade programming (context, not placement mechanics)`,source_file:null,preview:`The 8th-grade year carries a Social Issues Seminar culminating in an advocacy trip to Washington, D.C., in May (threadid=15), and an advocacy panel for 8th graders (threadid=40). These are curricular/civic, not high-school placement steps — do not present them as part of the placement process.`,text:`The 8th-grade year carries a Social Issues Seminar culminating in **an advocacy trip to
...
present them as part of the placement process.`},{subtopic:`⚠️ Confirmed absent — the placement process is largely unpublished`,source_file:null,preview:`Swept across all 100 sitemap pages + all 51 blog posts + both profile PDFs (1,637,243 characters). Every one of these returned zero hits: | What | Hits | Note | |---|--:|---| | SSAT | 0 | no outbound entrance test named | | HSPT | 0 | no outbound entrance test named | | SSATB / "Secondary School Admission" | 0 | | |…`,text:`Swept across all 100 sitemap pages + all 51 blog posts + both profile PDFs
...
---`},{subtopic:`Where They Land`,source_file:`Trinity Episcopal School - High School Placement - Where They Land.md`,preview:`# Trinity Episcopal School — High School Placement — Where They Land`,text:`# Trinity Episcopal School — High School Placement — Where They Land`},{subtopic:`Source URL`,source_file:null,preview:`- https://www.tescharlotte.org/editoruploads/files/26-27SchoolProfile.pdf > ⚠️ This URL 404s when the next edition ships. Both live editions were captured > 2026-09-16. The 24-25 edition and earlier are already gone from the web.`,text:`- https://www.tescharlotte.org/editoruploads/files/26-27SchoolProfile.pdf

> ⚠️ **This URL 404s when the next edition ships.** Both live editions were captured
> 2026-09-16. The 24-25 edition and earlier are already gone from the web.`},{subtopic:`What this list is`,source_file:null,preview:`The profile's own heading: "HIGH SCHOOL CHOICES (TES Classes of 2004-2026)" — a cumulative list across 23 graduating classes and 1,060 graduates, not a single-year destination list. 99 entries as published. It is a list of names only — the profile publishes no counts, no per-school student numbers and no per-year…`,text:`The profile's own heading: **"HIGH SCHOOL CHOICES (TES Classes of 2004-2026)"** — a
**cumulative** list across 23 graduating classes and **1,060 graduates**, not a
single-year destination list.

**99 entries as published.** It is a list of *names only* — the profile publishes **no
counts, no per-school student numbers and no per-year attribution**.`},{subtopic:`⚠️ The asterisk is UNEXPLAINED — do not interpret it`,source_file:null,preview:`41 of the 99 entries carry a trailing asterisk. The full extracted text of the PDF was searched for a legend — any "indicates", "denotes", or footnote — and none exists anywhere in the document. It plausibly marks multiple attendees or current attendance, but that is not stated. Publish no interpretation of it. Either…`,text:`**41 of the 99 entries carry a trailing asterisk.** The full extracted text of the PDF was
searched for a legend — any "indicates", "denotes", or footnote — and **none exists
anywhere in the document**.

It plausibly marks multiple attendees or current attendance, **but that is not stated**.
**Publish no interpretation of it.** Either strip the marker or omit the list; do not
invent a meaning. (The same is true of the **71 asterisked** college entries.)

One further unexplained marker: **"Woodberry Forest School, VA (7)"** carries a
parenthetical \`(7)\` with no explanation.`},{subtopic:`⚠️ The school's own duplicates and typos — preserve, do not silently fix`,source_file:null,preview:"The 99 lines are not 99 distinct schools. The school lists several institutions twice under different spellings: | | | |---|---| | `Cannon School` | `The Cannon School *` | | `Charlotte Catholic *` | `Charlotte Catholic High School` | | `Chambers High School` | `Julius L. Chambers High School` | | `JM Robinson High…",text:"The 99 lines are **not 99 distinct schools**. The school lists several institutions twice\nunder different spellings:\n\n| | |\n|---|---|\n| `Cannon School` | `The Cannon School *` |\n| `Charlotte Catholic *` | `Charlotte Catholic High School` |\n| `Chambers High School` | `Julius L. Chambers High School` |\n| `JM Robinson High School` | `Robinson High School` |\n\n**`Lake Normal High School`** is the school's own typo for **Lake Norman**."},{subtopic:`⭐ Many destinations are schools THIS APP already covers`,source_file:null,preview:`This is the cross-link no other school on the roster can offer — a K–8 school whose graduates feed directly into eight of the high schools we hold dossiers on.`,text:`This is the cross-link no other school on the roster can offer — a K–8 school whose
graduates feed directly into eight of the high schools we hold dossiers on.`},{subtopic:`The full list, as published (99 entries)`,source_file:null,preview:"| Destination | Dossier in this app | |---|---| | A.C. Reynolds High School | | | Ardrey Kell High School * | | | Asheville School, Asheville * | | | Bishop England High School, SC | | | Blair Academy, NJ | | | Brooklyn Friends School | | | Butler High School | | | Cannon School | `cannon` | | Cape Fear Academy | | |…",text:`| Destination | Dossier in this app |
|---|---|
...
| Butler High School | |
| Cannon School | \`cannon\` |
| Cape Fear Academy | |
| Cardinal Gibbons High School, FL | |
| Carmel Christian * | \`carmel-christian\` |
| Central High School | |
| Chambers High School | |
| Charlotte Catholic * | \`charlotte-catholic\` |
...
| Covenant Day School * | \`covenant-day\` |
...
| Hickory Grove Christian Academy * | \`hickory-grove-christian\` |
...
| Nauset High School, MA | |
| North Boise Jr. High School, ID | |
...
| Woodberry Forest School, VA (7) | |

---`},{subtopic:`⛔ The profile's COLLEGE list — NEVER rendered. Settled 2026-09-16.`,source_file:null,preview:`> Standing rule (user, 2026-09-16): no college card on a school that caps at 8th > grade. Raised at review and ruled out — *"no college card for schools that cap at > 8th grade."* It applies to every PreK–8 school, not just this one. The list below is > transcribed for provenance completeness and renders nowhere in…`,text:`> **Standing rule (user, 2026-09-16): no college card on a school that caps at 8th
...
Johns Hopkins, Northwestern, Vanderbilt, Rice, Tufts, Emory, Berkeley and Chicago.

**⚠️ THIS IS NOT A MATRICULATION LIST FOR A K–8 SCHOOL.** These are colleges Trinity
alumni attended **after finishing high school somewhere else** — typically 4+ years and
an entire high school career after leaving Trinity. Rendering it as a college-outcomes
card would attribute to Trinity an outcome it did not produce alone, which is why this
school ships **no College Support area at all**.

It is transcribed here for provenance completeness only.
