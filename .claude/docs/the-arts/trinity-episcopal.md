...
> Distilled from 2 source document(s) in `source-material/the-arts/trinity-episcopal/`. Auto-extracted full text, lightly cleaned. Rebuilt 2026-09-16.
**Documents:** Program Overview and Ensembles, Recognition and Exhibitions


---

## Program Overview and Ensembles

*Source file: `Trinity Episcopal School - The Arts - Program Overview and Ensembles.md`*
...
*Source file: `Trinity Episcopal School - The Arts - Recognition and Exhibitions.md`*

# Trinity Episcopal School — The Arts — Recognition and Exhibitions

## Provenance

- **Retrieved by:** Claude (Claude Code agent), on behalf of Derrick.
- **Retrieval date:** 2026-09-16
- **Method:** All 98 non-PDF sitemap URLs fetched into a local corpus and grepped;
 quotes are char-for-char from raw page source.
- **School:** Trinity Episcopal School, 750 E. 9th Street, Charlotte, NC 28202 — **K–8**.

### ⚠️ Student names are deliberately omitted

**Every award below was won by a named K–8 student, and those names are deliberately
not recorded here.** Project rule, set by the user 2026-09-16: report the recognition —
the award, venue, date, count and denominator — without identifying the child. These are
minors, and the research value is in *what the school wins and where*, not in who won it.

**Adults are named in their professional capacity** (the Visual Arts Director, the art
teacher), which is standard for staff across the roster.

### ⚠️ These findings REVERSE an earlier assumption

The `/add-school` sweep recorded "no awards or recognition of any kind" and "no gallery
or exhibit programme" as **confirmed absent** for this area. **Both are wrong.** They were
established from the two Enrichments pages, which genuinely carry no awards content — but
the arts recognition lives in the **blog**, which that sweep did not enumerate. A search
scoped to the obvious pages produced a confident false negative.

## Source URLs

- Trinity artists honored — https://www.tescharlotte.org/trinity-artists-honored-in-local-exhibits/
- CATO teaching award — https://www.tescharlotte.org/jen-rankey-zona-receives-excellence-in-teaching-award/
- Ghana art exchange — https://www.tescharlotte.org/fifth-grade-continues-art-exchange-with-ghana-students/

## Student recognition — March 2026

From "Trinity Artists Honored in Local Exhibits", **March 7, 2026**:
...
> "I am truly so honored to teach these wonderful artists."

## Faculty recognition — May 2025

**Jen Rankey-Zona**, **Visual Arts Director** and a **founding teacher** of the school,
...
> "Her impact is felt deeply at Trinity and far beyond."

## An international art exchange — ongoing since 2023-24

From "Fifth Grade Continues Art Exchange with Ghana Students", **October 29, 2024**.
...
## What this material supports, and what it does not

**Supports:** a `visual` card ("Studio to Gallery") with genuine recognition —
...
- https://vimeo.com/1059308131
- https://vimeo.com/1059929386
- https://vimeo.com/1089330054
- https://vimeo.com/420866235
- https://vimeo.com/420867281
- https://vimeo.com/421094281
- https://vimeo.com/637686767
- https://vimeo.com/642493556
- https://vimeo.com/647455856
- https://vimeo.com/api/v2/tescharlotte/videos.json
- https://vimeo.com/api/v2/tescharlotte/videos.json`
- https://www.tescharlotte.org/academics/lower-school-enrichments.cfm
- https://www.tescharlotte.org/academics/lower-school/ls-curriculum`
