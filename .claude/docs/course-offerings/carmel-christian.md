...
> Distilled from 2 source document(s) in `source-material/course-offerings/carmel-christian/`. Auto-extracted full text, lightly cleaned. Rebuilt 2026-08-18.
...
*Source file: `Carmel Christian - Course Offerings - Curriculum Guide.md`*
...
*Source file: `Carmel Christian - Course Offerings - Elementary Curriculum Guide.md`*

# Carmel Christian School — Course Offerings — Elementary Curriculum Guide
...
- **Scope:** Kindergarten through Grade 5, by subject, plus a "Special Areas (All Grades)"
 ...
 named, describable Lower School course list.
...
| Curricula named | Orton-Gillingham (phonics), Science of Reading, Accelerated Reader (from Gr 1), Analytical Grammar (Gr 5), Singapore-style hands-on math, Dash robots / Lego / 3D printing (STEM) |

## Core curriculum (K–5, from the guide)

**Bible (K–5):** Who God is through Creation and the Old/New Testament and Christ; Bible
...
Carolina history through Reconstruction (Gr 4) → early American history 1400s–1880s (Gr 5).

## Special Areas (All Grades, from the guide)

- **Art** — foundational construction skills (painting, drawing, cutting, collage); elements
...
- **STEM** — the STEM Lab: engineering builds, Dash-robot coding, codable Lego kits, 3D
 printer designs; often tied to the classroom science curriculum.

## Notes

- The elementary guide describes subjects **by grade**, not as distinctly-titled courses
...
- https://drive.google.com/file/d/1WWkiHYPy9PVPCAMgzsNr1yV6TdsovRNE/view
- https://www.calameo.com/read/00320361962a97fb5020d`
- https://www.calameo.com/read/003203619b939a7cb178b
- https://www.carmelchristian.org/apps/pages/index.jsp?uREC_ID=587939&type=d&pREC_ID=1133088
- https://www.carmelchristian.org/ourpages/auto/2024/8/28/37308823/HS_Graduation_Requirements_26_27.pdf
