...
> Distilled from 1 source document(s) in `source-material/course-offerings/hickory-grove-christian/`. Auto-extracted full text, lightly cleaned. Rebuilt 2026-08-17.
