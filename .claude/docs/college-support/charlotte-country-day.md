...
> Distilled from 10 source document(s) in `source-material/college-support/charlotte-country-day/`. Auto-extracted full text, lightly cleaned. Rebuilt 2026-09-16.
...
*Source file: `CCD - College Support - Academic Case.pdf`*

Charlotte Country Day School College Support (cid:127) The Academic Case
SEGMENT 2 (cid:127) COLLEGE SUPPORT
The Academic Case
...
overlapping windows.
Parent-facing research dossier (cid:127) Outcomes reported in aggregate; no individual student names. Page 1
Charlotte Country Day School College Support (cid:127) The Academic Case
...
(cid:127) Calculus III / IB Analysis HL and Advanced AP Statistics with R and R Studio (mathematics);
(cid:127) Organic Chemistry and Physical Computational Biochemistry (science);
(cid:127) A summer Science Outreach Program placing motivated students as researchers in college labs.
...
Testing landscape
Parent-facing research dossier (cid:127) Outcomes reported in aggregate; no individual student names. Page 2
Charlotte Country Day School College Support (cid:127) The Academic Case
...
Parent-facing research dossier (cid:127) Outcomes reported in aggregate; no individual student names. Page 3
...
*Source file: `CCD - College Support - Application Support.pdf`*

Charlotte Country Day School College Support (cid:127) Application Support
SEGMENT 4 (cid:127) COLLEGE SUPPORT
Application Support
...
(cid:127) Morehead-Cain Scholars (UNC–Chapel Hill) and Jefferson and Echols Scholars (University of
Virginia);
(cid:127) Coca-Cola Scholar, Jack Kent Cooke Scholar, QuestBridge College Match Scholar, and Ron Brown
Scholar;
(cid:127) U.S. Service Academy appointments.
Parent-facing research dossier (cid:127) Outcomes reported in aggregate; no individual student names. Page 1
Charlotte Country Day School College Support (cid:127) Application Support
...
*Source file: `CCD - College Support - Counseling Engine.pdf`*

Charlotte Country Day School College Support (cid:127) The Counseling Engine
SEGMENT 1 (cid:127) COLLEGE SUPPORT
...
(cid:127) Associate Director — Meredith High: came to Country Day from Davidson College, where she
...
Richmond.
(cid:127) Associate Director — Brooke Tevlin: joined in July 2025 with 25+ years across independent
...
(cid:127) Associate Director — Jonathan Woog: holds an M.Ed. in English Education and is an active
member of the regional admission-counseling association.
Parent-facing research dossier (cid:127) Outcomes reported in aggregate; no individual student names. Page 1
Charlotte Country Day School College Support (cid:127) The Counseling Engine
(cid:127) Registrar — Donna Witman: recognized for 35 years of service; a long-tenured anchor of the
...
*Source file: `CCD - College Support - Fit and Rank.pdf`*

Charlotte Country Day School College Support (cid:127) Fit, Rank & the Whole Class
SEGMENT 7 (cid:127) COLLEGE SUPPORT
...
*Source file: `CCD - College Support - Institutional Leverage.pdf`*

Charlotte Country Day School College Support (cid:127) Institutional Leverage
SEGMENT 3 (cid:127) COLLEGE SUPPORT
Institutional Leverage
...
*Source file: `CCD - College Support - NotebookLM Prompt.txt`*

Create a two-host conversational podcast, "Inside Charlotte Country Day College Support." Warm, balanced, plain-spoken — explaining a school to curious parents. Cover ALL SEVEN segments IN ORDER, then a SEPARATE closing. Every segment gets real airtime; don't front-load. Use AT MOST ONE analogy in the whole episode.

GLOBAL RULES:
- No hype: never "elite," "powerhouse," "world-class," or "dynasty" unless a cited figure supports it.
- Unpublished is NOT deficient: when the school doesn't publish something, say so and frame it as a transparency gap, never a weakness — re-apply every time a gap comes up.
- Never speak a student's name; don't name counselors or staff either — use roles ("the incoming Director of College Counseling").
- Bracketed hints are for you only; never read them aloud.

PRONUNCIATION: Scoir = say "score" (do NOT spell S-C-O-I-R). FAFSA = "FAF-suh." Say "C.S.S. Profile," "A.P.," "I.B.," "Power Four," "Top Seventy-Five," "Division One/Two/Three." On first use, gloss "yield" (the share of admitted students who enroll), "matriculation" (where students actually enroll), and "Ivy Plus" (the eight Ivy League schools plus about nine similarly selective peers — seventeen in all).

Open by stating the full agenda in one plain sentence.

(1) THE COUNSELING ENGINE. Four full-time counselors plus a registrar for ~548 Upper School students; senior caseload ~34-35. A newly hired Director — Princeton graduate, nationally published admissions writer, fit-over-prestige — framed as direction, not a track record here yet. Real admissions-office depth (a former Associate Dean of Admission at Davidson; an enrollment-management leader). Platform is Scoir from sophomore year. Gap: whether Scoir scattergrams are on for families isn't published.

(2) THE ACADEMIC CASE. The most-documented area. 2025 A.P.: 530 exams, 93% scored 3-plus, 74% scored 4-5, by discipline. First I.B. school in North Carolina; ~20 diploma students a year; five-year pass rate 88% — present the earlier 91% and current 88% as overlapping rolling windows, not a drop. SAT/ACT published by GPA quintile (top ~1470 SAT / 33 A.C.T. down to ~1110 / 24). Twenty-five A.P. courses, honors in 17 subjects, full I.B., plus post-A.P. electives. Gap: no direct grade comparison to local public schools.

(3) INSTITUTIONAL LEVERAGE. The public School Profile is the key lever — grading policy, GPA quintiles, A.P./I.B. results, and a four-year acceptance list let a reader place any student in context. 150-plus college reps visit. Gap: year-over-year yield with named colleges isn't published.

(4) APPLICATION SUPPORT. Counselors review EVERY application before submission. Early strategy in use (Class of 2025: 39% Early Decision, 88% Early Action). Recommendation letters managed and edited by the office. ~$13 million in scholarships offered to one class across many awards. Financial aid: FAFSA and C.S.S. Profile referenced — partial; a formal appeals workflow isn't published. Senior externships with ~175 employers.

(5) STANDING OUT — its OWN beat, at least two concrete specifics; do NOT skip it. How a hook gets built: values-first counseling plus distinctive platforms — senior externships, a summer research program in college labs, a 330-acre working farm. Athletic recruiting at process level: athletics and counseling partner; ~16 seniors a year commit to N.C.A.A. Division One/Two/Three (aggregate, no names). Arts portfolios: referral-level support, not a named in-house pipeline — state that gap.

(6) THE OUTCOMES. Report as list BREADTH, never a placement rate. From the four-year acceptance list: Ivy League 7 of 8; Ivy Plus 15 of 17; ~58 Top-Seventy-Five National Universities and ~24 Top-Seventy-Five Liberal Arts Colleges; 63 Power Four schools. Name a few of the highest-ranked (Princeton, M.I.T., Stanford, Williams). Gaps to state plainly: share of the class to each tier, year-over-year yield, and post-enrollment persistence and graduation are all unpublished.

(7) FIT, RANK & THE WHOLE CLASS — its OWN beat, at least two specifics; do NOT collapse it. No class rank — GPA by quintile, including the lower quintiles (a transparency signal). Whole-class support: every student gets a counselor; capacity was recently expanded. Learning differences: a JK-12 resource program helps request testing accommodations with the College Board, A.C.T., and I.B. Fit over prestige, backed by varied destinations (H.B.C.U.s, women's colleges, service academies).

CLOSING — a SEPARATE beat; do NOT continue Segment 7. Start with a pivot ("To pull this together..."), give exactly THREE one-line takeaways spanning the episode (e.g., outcome transparency; fit-first direction; honest gaps), then end on this exact idea as the FINAL sentence with NOTHING after it: we reported only what the school publishes and what our research surfaced, and where a figure isn't published, that's a transparency gap, not a verdict on quality.
...
*Source file: `CCD - College Support - Outcomes.pdf`*

Charlotte Country Day School College Support (cid:127) The Outcomes
SEGMENT 6 (cid:127) COLLEGE SUPPORT
The Outcomes
...
*Source file: `CCD - College Support - Redesign Research 2026.md`*
...
*Source file: `CCD - College Support - Standing Out.pdf`*

Charlotte Country Day School College Support (cid:127) Standing Out
SEGMENT 5 (cid:127) COLLEGE SUPPORT
Standing Out
...
(cid:127) Senior Externships — shadowing and mentorship with nearly 175 employers, aligned to a
student's career interest;
(cid:127) Science Outreach Program — a summer route to serving as a researcher in college labs;
(cid:127) Weddington Farm — a 330-acre working classroom supporting sustainable-agriculture, ecology,
and entrepreneurship projects;
(cid:127) 45 clubs and activities, leadership councils, and 50+ arts events a year, plus
...
*Source file: `Charlotte Country Day School - College Support - UNC System Admissions.md`*
