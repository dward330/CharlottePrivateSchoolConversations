...
> Distilled from 1 source document(s) in `source-material/admissions/hickory-grove-christian/`. Auto-extracted full text, lightly cleaned. Rebuilt 2026-09-02.
...
*Source file: `Hickory Grove Christian - Admissions - Grade-by-Grade Application Plans.md`*

# Hickory Grove Christian — Admissions — Grade-by-Grade Application Plans

## Provenance

- **Compiled:** 2026-09-01 during `/plan hickorygroveadmissions`, from a deep-research pass
 plus independent live verification of hgchristian.org — including **retrieval of both
 admission-checklist PDFs**, which the prior pass recorded as permission-blocked.
- **Sourcing constraint:** official hgchristian.org pages, its linked FACTS portals, its
 Finalsite-hosted PDFs, and the sponsoring church's own linked ministry page ONLY. No
 third-party or aggregator source was used for any factual claim.
- **Cycle:** 2027–28 entry is the open application cycle. See the cycle audit.
- **A ministry of Hickory Grove Baptist Church**, Charlotte NC. Two campuses.

## ⚠️ Cycle audit

**The open application cycle is 2027–28**, published on the Admissions Process page
(rendered 2026-09-01):
...
labels. The Process page carries the dated, specific content and is the better source.

## ⚠️ The website's THREE steps are not the real process — the checklists publish FOUR

The Admissions Process page presents **STEP 1: INQUIRE → STEP 2: VISIT → STEP 3: APPLY**.
...
## Structure — four grade bands plus a separate International band

| Band | Grades | Forms | Assessment | Shadow | Campus |
|---|---|---|---|---|---|
...
published only for 9–12**.

## The two admission checklists — RETRIEVED IN FULL

**Method note:** the prior pass recorded both as NOT RETRIEVED ("fetch was permission-blocked
because the resource-manager URLs never surfaced in a searchable index"). They are
...
5. **A published automatic-denial rule** — suspensions, expulsions or failed courses.

## The Christian-commitment question — ANSWERED

The prior pass recorded a mandatory Christian-commitment requirement as "NOT explicitly
...
**The full verbatim Statement of Faith text remains NOT RETRIEVED** (referenced only).

## Age eligibility — TK vs K5 — VERBATIM

From the school's own "TK or K5" page:
...
**No independent-toileting requirement is published** for TK/K5.

## Campus is an admissions dimension

- **Harris Campus** — 7200 E. WT Harris Blvd., Charlotte NC 28215. TK–12 plus a **full-day**
...
## Financial aid — and its order-of-operations precondition

**Platform:** FACTS Grant & Aid. **"There is a $40 application charge from FACTS."**
...
**A reduced enrollment deposit for aid applicants is NOT PUBLISHED.**

## International Program (F-1) — a genuinely separate process

**Director:** Sheila M. Chaney, Director of Admissions and International Student Program —
...
to international students, and host-family vetting/background-check specifics.

## All-applicant policies

- **Admissions priority** — an *earlier application window*, not a tuition discount, for
...
The school describes itself as an **Early Education Center, Elementary School, Middle School,
and High School**. Published grade spans: **Elementary School (TK–5), Middle School (6th–8th),
High School (9th–12th)**.

## Tuition — NOT PUBLISHED on the site

**⚠️ Correction to the prior pass:** it treated the two fee PDFs linked from the Tuition & Fees
...
assumption was wrong and should not be repeated.

## Admissions office contact — as published

**Director of Admissions & International Student Program:** Sheila M. Chaney —
...
**Only ONE admissions staff member is named** anywhere on the site.

## NOT PUBLISHED / NOT RETRIEVED

- **Full verbatim Statement of Faith** — referenced only.
...
- **The 2027–28 NCSEAA application window** — set by the state, not yet published.

## Confusable-school note

Content from **Hickory Christian Academy (Hickory, NC)** — a different school with Sept 1 /
...
School and Grace Christian School (VT) were never treated as HGCS policy.

## Source list (official URLs, verified 2026-09-01)

- <https://hgchristian.org/admissions/admissions-process> — **rendered**; the three website
...
- https://hg-nc.client.factsmgt.com/oa/index.cfm?memberid=496>
...
- https://hgchristian.org/admissions/international-program/host-families>
- https://hgchristian.org/admissions/international-program/international-student-enrollment-process>
- https://hgchristian.org/admissions/scholarships>
- https://hgchristian.org/admissions/tuition-and-fees>
- https://hickorygrove.org/ministries/other-ministries/christian-school/>
- https://www.hgchristian.org/fs/resource-manager/view/7dd54753-7033-45a4-8e4b-9f62e25bc311>
- https://www.hgchristian.org/fs/resource-manager/view/adf10069-819d-4420-83c4-ebba8281c071>
- https://www.hgchristian.org/fs/resource-manager/view/c7376a64-1d57-4a98-a5fb-6cab591a4c65>
