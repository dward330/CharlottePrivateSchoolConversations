...
already written during planning, or still to be fetched — with their sources, and note
that `/implement` ingests them first. Omit this section when no new data is involved.
