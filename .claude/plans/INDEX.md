...
| [add-nc-admissions-data](add-nc-admissions-data.md) | College Support — new first card "Admissions Rate for Top NC Public Universities", populated from the UNC Insight dashboard via the nc-admissions-data skill | 2026-08-19 | Implemented | [#156](https://github.com/dward330/CharlottePrivateSchoolConversations/pull/156) |
