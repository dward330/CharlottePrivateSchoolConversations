...
| [topicguard](topicguard.md) | Verify `check:live`'s `FOREIGN_TOPICS` allowlist against the content extractor instead of trusting it | 2026-08-20 | Not implemented | — |
| [halfday](halfday.md) | Translate 'Half day' — the one day-vocabulary value with no chrome key, rendering English in all nine locales | 2026-08-20 | Not implemented | — |
